(() => {
    ...
    class s extends Error {
        ...
        static isErrorNoTelemetry(e) {
            return "ErrorNoTelemetry" === e.name
        }
    }
    Error;
    ...
    ! function(e) {
        ...
        }, e.consume = n, e.collect = function(e) {
            return n(e)[0]
    ...
    function u(e) {
        return null == h || h.trackDisposable(e), e
    }

    function d(e) {
        null == h || h.markAsDisposed(e)
    }

    function f(e, t) {
        null == h || h.setParent(e, t)
    }

    function m(e, t) {
        if (h)
            for (const n of e) h.setParent(n, t)
    }
    ...
    class v {
        constructor(e) {
            this.element = e, this.next = v.Undefined, this.prev = v.Undefined
        }
    }
    v.Undefined = new v(void 0);
    class S {
        constructor() {
        ...
        clear() {
            ...
            for (; e !== v.Undefined;) {
                const t = e.next;
                e.prev = v.Undefined, e.next = v.Undefined, e = t
            }
            this._first = v.Undefined, this._last = v.Undefined, this._size = 0
        }
        unshift(e) {
        ...
        _remove(e) {
            if (e.prev !== v.Undefined && e.next !== v.Undefined) {
                const t = e.prev;
                t.next = e.next, e.next.prev = t
            } else e.prev === v.Undefined && e.next === v.Undefined ? (this._first = v.Undefined, this._last = v.Undefined) : e.next === v.Undefined ? (this._last = this._last.prev, this._last.next = v.Undefined) : e.prev === v.Undefined && (this._first = this._first.next, this._first.prev = v.Undefined);
            this._size -= 1
        }*[Symbol.iterator]() {
            let e = this._first;
            for (; e !== v.Undefined;) yield e.element, e = e.next
        }
    }
    let L = "undefined" != typeof document && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
    ...
    function N(e, t) {
        ...
        return n = 0 === t.length ? e : e.replace(/\{(\d+)\}/g, ((e, n) => {
            const r = n[0],
                i = t[r];
            let o = e;
            return "string" == typeof i ? o = i : "number" != typeof i && "boolean" != typeof i && null != i || (o = String(i)), o
    ...
    let M, R, O = !1,
        ...
        B = null,
        U = null;
    const q = "object" == typeof self ? self : "object" == typeof e.g ? e.g : {};
    let H;
    void 0 !== q.vscode && void 0 !== q.vscode.process ? H = q.vscode.process : "undefined" != typeof process && (H = process);
    const W = "string" == typeof(null === (A = null == H ? void 0 : H.versions) || void 0 === A ? void 0 : A.electron),
        $ = W && "renderer" === (null == H ? void 0 : H.type);
    if ("object" != typeof navigator || $)
        if ("object" == typeof H) {
            O = "win32" === H.platform, x = "darwin" === H.platform, T = "linux" === H.platform, I = T && !!H.env.SNAP && !!H.env.SNAP_REVISION, D = W, F = !!H.env.CI || !!H.env.BUILD_ARTIFACTSTAGINGDIRECTORY, M = k, B = k;
            const e = H.env.VSCODE_NLS_CONFIG;
            if (e) try {
                const t = JSON.parse(e),
                    n = t.availableLanguages["*"];
                M = t.locale, B = n || k, U = t._translationsConfigFile
            } catch (e) {}
            P = !0
        } else console.error("Unable to resolve platform.");
    else {
        R = navigator.userAgent, O = R.indexOf("Windows") >= 0, x = R.indexOf("Macintosh") >= 0, V = (R.indexOf("Macintosh") >= 0 || R.indexOf("iPad") >= 0 || R.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, T = R.indexOf("Linux") >= 0, K = !0;
        M = void E({
    ...
    const j = O,
        G = x,
        Y = (K && q.importScripts, R),
        Z = "function" == typeof q.postMessage && !q.importScripts;
    (() => {
        if (Z) {
            const e = [];
            q.addEventListener("message", (t => {
    ...
    const J = !!(Y && Y.indexOf("Chrome") >= 0),
        Q = (Y && Y.indexOf("Firefox"), !J && Y && Y.indexOf("Safari"), Y && Y.indexOf("Edg/"), Y && Y.indexOf("Android"), q.performance && "function" == typeof q.performance.now);
    class X {
        constructor(e) {
            this._highResolution = Q && e, this._startTime = this._now(), this._stopTime = -1
        }
        static create() {
            return new X(!(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0])
        }
        stop() {
    ...
    ! function(e) {
        ...
        e.None = () => _.None, e.once = n, e.map = r, e.forEach = i, e.filter = o, e.signal = function(e) {
            ...
            const o = () => {
                    null == r || r.forEach((e => a.fire(e))), r = null
                },
                a = new ie({
                    onFirstListenerAdd() {
                        i || (i = e((e => a.fire(e))))
        ...
        class h {
            constructor(e) {
                this.event = e, this.disposables = new w
            }
            map(e) {
                return new h(r(this.event, e, this.disposables))
            }
            forEach(e) {
                return new h(i(this.event, e, this.disposables))
            }
            filter(e) {
                return new h(o(this.event, e, this.disposables))
            }
            reduce(e, t) {
                return new h(a(this.event, e, t, this.disposables))
            }
            latch() {
                return new h(c(this.event, void 0, this.disposables))
            }
            debounce(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 100,
                    n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                    r = arguments.length > 3 ? arguments[3] : void 0;
                return new h(l(this.event, e, t, n, r, this.disposables))
            }
            on(e, t, n) {
        ...
        class u {
            constructor(e, n) {
                this.obs = e, this._counter = 0, this._hasChanged = !1;
                const r = {
                    onFirstListenerAdd: () => {
                        e.addObserver(this)
                    },
                ...
                n || t(), this.emitter = new ie(r), n && n.add(this.emitter)
            }
            beginUpdate(e) {
                this._counter++
            }
            ...
            endUpdate(e) {
                0 == --this._counter && this._hasChanged && (this._hasChanged = !1, this.emitter.fire(this.obs.get()))
            }
        }
    ...
    class te {
        constructor(e) {
            this._listenerCount = 0, this._invocationCount = 0, this._elapsedOverall = 0, this._name = `${e}_${te._idPool++}`
        }
        start(e) {
            this._stopWatch = new X(!0), this._listenerCount = e
        }
        stop() {
            if (this._stopWatch) {
    ...
    class ne {
        ...
        static create() {
            var e;
            return new ne(null !== (e = (new Error).stack) && void 0 !== e ? e : "")
        }
        print() {
    ...
    class ie {
        constructor(e) {
            var t, n;
            this._disposed = !1, this._options = e, this._leakageMon = void 0, this._perfMon = (null === (t = this._options) || void 0 === t ? void 0 : t._profName) ? new te(this._options._profName) : void 0, this._deliveryQueue = null === (n = this._options) || void 0 === n ? void 0 : n.deliveryQueue
        }
        dispose() {
            var e, t, n, r;
            this._disposed || (this._disposed = !0, this._listeners && this._listeners.clear(), null === (e = this._deliveryQueue) || void 0 === e || e.clear(this), null === (n = null === (t = this._options) || void 0 === t ? void 0 : t.onLastListenerRemove) || void 0 === n || n.call(t), null === (r = this._leakageMon) || void 0 === r || r.dispose())
        }
        get event() {
            return this._event || (this._event = (e, t, n) => {
                ...
                let s, l;
                a && (null === (r = this._options) || void 0 === r ? void 0 : r.onFirstListenerAdd) && this._options.onFirstListenerAdd(this), this._leakageMon && this._listeners.size >= 30 && (l = ne.create(), s = this._leakageMon.check(l, this._listeners.size + 1));
                const c = new re(e, t, l),
                ...
                const u = c.subscription.set((() => {
                    if (null == s || s(), !this._disposed && (h(), this._options && this._options.onLastListenerRemove)) {
        ...
        fire(e) {
            var t, n;
            if (this._listeners) {
                this._deliveryQueue || (this._deliveryQueue = new oe);
                for (const t of this._listeners) this._deliveryQueue.push(this, t, e);
                null === (t = this._perfMon) || void 0 === t || t.start(this._deliveryQueue.size), this._deliveryQueue.deliver(), null === (n = this._perfMon) || void 0 === n || n.stop()
            }
        }
    }
    class oe extends class {
        ...
        push(e, t, n) {
            this._queue.push(new ae(e, t, n))
        }
        clear(e) {
            const t = new S;
            for (const n of this._queue) n.emitter !== e && t.push(n);
            this._queue = t
        }
        deliver() {
    ...
    class ae {
        constructor(e, t, n) {
            this.emitter = e, this.listener = t, this.event = n
        }
    }
    ...
    class we {
        ...
        static getInstance(e) {
            return we.cache.get(Array.from(e))
        }
        static getLocales() {
            return we._locales.getValue()
        }
        isAmbiguous(e) {
    ...
    he = we, we.ambiguousCharacterData = new ce((() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,8218,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,8242,96,1370,96,1523,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71922,67,71913,67,65315,67,8557,67,8450,67,8493,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71919,87,71910,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,66293,90,71909,90,65338,90,8484,90,8488,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65297,49,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125],"_default":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"cs":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"es":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"fr":[65374,126,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"it":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ja":[8211,45,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65292,44,65307,59],"ko":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pt-BR":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ru":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"zh-hans":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41],"zh-hant":[8211,45,65374,126,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65307,59]}'))), we.cache = new class {
        ...
        const r = he.ambiguousCharacterData.getValue();
        ...
        return new we(a)
    })), we._locales = new ce((() => Object.keys(we.ambiguousCharacterData.getValue()).filter((e => !e.startsWith("_")))));
    class _e {
        static getRawData() {
    ...
    class ke {
        ...
        sendMessage(e, t) {
            ...
            return new Promise(((r, i) => {
                this._pendingReplies[n] = {
                    resolve: r,
                    reject: i
                }, this._send(new Se(this._workerId, n, e, t))
            }))
        }
        listen(e, t) {
            let n = null;
            const r = new ie({
                onFirstListenerAdd: () => {
                    n = String(++this._lastSentReq), this._pendingEmitters.set(n, r), this._send(new Ne(this._workerId, n, e, t))
                },
                onLastListenerRemove: () => {
                    this._pendingEmitters.delete(n), this._send(new Ae(this._workerId, n)), n = null
                }
            });
            return r.event
        }
        ...
        _handleRequestMessage(e) {
            ...
            this._handler.handleMessage(e.method, e.args).then((e => {
                this._send(new Le(this._workerId, t, e, void 0))
            }), (e => {
                e.detail instanceof Error && (e.detail = r(e.detail)), this._send(new Le(this._workerId, t, void 0, r(e)))
            }))
        }
        _handleSubscribeEventMessage(e) {
            const t = e.req,
                n = this._handler.handleEvent(e.eventName, e.arg)((e => {
                    this._send(new Ee(this._workerId, t, e))
                }));
    ...
    function Me(e) {
        return "o" === e[0] && "n" === e[1] && de(e.charCodeAt(2))
    }
    ...
    function Oe(e, t, n) {
        const r = e => function() {
            ...
            o = {};
        for (const t of e) Re(t) ? o[t] = i(t) : Me(t) ? o[t] = n(t, void 0) : o[t] = r(t);
        return o
    }
    class xe {
        constructor(e, t) {
            this._requestHandlerFactory = t, this._requestHandler = null, this._protocol = new ke({
                sendMessage: (t, n) => {
                    e(t, n)
                },
        ...
        _handleMessage(e, t) {
            if (e === ye) return this.initialize(t[0], t[1], t[2], t[3]);
        ...
        initialize(e, t, n, r) {
            ...
            const i = Oe(r, ((e, t) => this._protocol.sendMessage(e, t)), ((e, t) => this._protocol.listen(e, t)));
            return this._requestHandlerFactory ? (this._requestHandler = this._requestHandlerFactory(i), Promise.resolve(se(this._requestHandler))) : (t && (void 0 !== t.baseUrl && delete t.baseUrl, void 0 !== t.paths && void 0 !== t.paths.vs && delete t.paths.vs, void 0 !== typeof t.trustedTypesPolicy && delete t.trustedTypesPolicy, t.catchError = !0, q.require.config(t)), new Promise(((e, t) => {
                (0, q.require)([n], (n => {
                    this._requestHandler = n.create(i), this._requestHandler ? e(se(this._requestHandler)) : t(new Error("No RequestHandler!"))
                }), t)
            })))
        }
    }
    ...
    function Pe(e, t) {
        t = Ie(149417, t);
        for (let n = 0, r = e.length; n < r; n++) t = Ie(e.charCodeAt(n), t);
        return t
    }
    ...
    function Fe(e) {
        ...
        return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((e => e.toString(16).padStart(2, "0"))).join("") : Ve((e >>> 0).toString(16), t / 4)
    }
    class Be {
        constructor() {
        ...
        digest() {
            return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), Fe(this._h0) + Fe(this._h1) + Fe(this._h2) + Fe(this._h3) + Fe(this._h4)
        }
        _wrapUp() {
            this._buff[this._buffLen++] = 128, De(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), De(this._buff));
        ...
        _step() {
            ...
            for (let t = 64; t < 320; t += 4) e.setUint32(t, Ke(e.getUint32(t - 12, !1) ^ e.getUint32(t - 32, !1) ^ e.getUint32(t - 56, !1) ^ e.getUint32(t - 64, !1), 1), !1);
            let n, r, i, o = this._h0,
                a = this._h1,
                s = this._h2,
                l = this._h3,
                c = this._h4;
            for (let t = 0; t < 80; t++) t < 20 ? (n = a & s | ~a & l, r = 1518500249) : t < 40 ? (n = a ^ s ^ l, r = 1859775393) : t < 60 ? (n = a & s | a & l | s & l, r = 2400959708) : (n = a ^ s ^ l, r = 3395469782), i = Ke(o, 5) + n + c + r + e.getUint32(4 * t, !1) & 4294967295, c = l, l = s, s = Ke(a, 30), a = o, o = i;
    ...
    function qe(e, t, n) {
        return new ze(new Ue(e), new Ue(t)).ComputeDiff(n).changes
    }
    class He {
        static Assert(e, t) {
    ...
    class ze {
        constructor(e, t) {
            ...
            const [r, i, o] = ze._getElements(e), [a, s, l] = ze._getElements(t);
        ...
        static _getElements(e) {
            ...
            if (ze._isStringArray(t)) {
                const e = new Int32Array(t.length);
                for (let n = 0, r = t.length; n < r; n++) e[n] = Pe(t[n], 0);
                return [t, e, !0]
            }
        ...
        ElementsAreStrictEqual(e, t) {
            ...
            return ze._getStrictElement(this._originalSequence, e) === ze._getStrictElement(this._modifiedSequence, t)
        }
        ...
        ComputeDiffRecursive(e, t, n, r, i) {
            ...
            if (e > t || n > r) {
                let i;
                return n <= r ? (He.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), i = [new Te(e, 0, n, r - n + 1)]) : e <= t ? (He.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"), i = [new Te(e, t - e + 1, n, 0)]) : (He.Assert(e === t + 1, "originalStart should only be one more than originalEnd"), He.Assert(n === r + 1, "modifiedStart should only be one more than modifiedEnd"), i = []), i
            }
            const o = [0],
                a = [0],
            ...
            if (!i[0]) {
                ...
                let a = [];
                return a = i[0] ? [new Te(l + 1, t - (l + 1) + 1, c + 1, r - (c + 1) + 1)] : this.ComputeDiffRecursive(l + 1, t, c + 1, r, i), this.ConcatenateChanges(o, a)
            }
            return [new Te(e, t - e + 1, n, r - n + 1)]
        }
        WALKTRACE(e, t, n, r, i, o, a, s, l, c, h, u, d, f, m, g, b, C) {
            ...
            do {
                const t = S + e;
                t === y || t < v && l[t - 1] < l[t + 1] ? (f = (h = l[t + 1]) - S - r, h < L && _.MarkNextChange(), L = h, _.AddModifiedElement(h + 1, f), S = t + 1 - e) : (f = (h = l[t - 1] + 1) - S - r, h < L && _.MarkNextChange(), L = h - 1, _.AddOriginalElement(h, f + 1), S = t - 1 - e), N >= 0 && (e = (l = this.m_forwardHistory[N])[0], y = 1, v = l.length - 1)
            } while (--N >= -1);
            if (p = _.getReverseChanges(), C[0]) {
                ...
                w = [new Te(e, u - e + 1, t, m - t + 1)]
            } else {
                _ = new $e, y = o, v = a, S = d[0] - g[0] - s, L = 1073741824, N = b ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                do {
                    const e = S + i;
                    e === y || e < v && c[e - 1] >= c[e + 1] ? (f = (h = c[e + 1] - 1) - S - s, h > L && _.MarkNextChange(), L = h + 1, _.AddOriginalElement(h + 1, f + 1), S = e + 1 - i) : (f = (h = c[e - 1]) - S - s, h > L && _.MarkNextChange(), L = h, _.AddModifiedElement(h + 1, f + 1), S = e - 1 - i), N >= 0 && (i = (c = this.m_reverseHistory[N])[0], y = 1, v = c.length - 1)
                } while (--N >= -1);
                w = _.getChanges()
            }
        ...
        ComputeRecursionPoint(e, t, n, r, i, o, a) {
            ...
            const f = t - e + (r - n),
                ...
                y = (p - C) % 2 == 0;
            g[C] = e, b[p] = t, a[0] = !1;
            for (let v = 1; v <= f / 2 + 1; v++) {
                let f = 0,
                    S = 0;
                c = this.ClipDiagonalBound(C - v, v, C, m), h = this.ClipDiagonalBound(C + v, v, C, m);
                for (let e = c; e <= h; e += 2) {
                    s = e === c || e < h && g[e - 1] < g[e + 1] ? g[e + 1] : g[e - 1] + 1, l = s - (e - C) - w;
                    const n = s;
                    for (; s < t && l < r && this.ElementsAreEqual(s + 1, l + 1);) s++, l++;
                    if (g[e] = s, s + l > f + S && (f = s, S = l), !y && Math.abs(e - p) <= v - 1 && s >= b[e]) return i[0] = s, o[0] = l, n <= b[e] && v <= 1448 ? this.WALKTRACE(C, c, h, w, p, u, d, _, g, b, s, t, i, l, r, o, y, a) : null
                }
                const L = (f - e + (S - n) - v) / 2;
                if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(f, L)) return a[0] = !0, i[0] = f, o[0] = S, L > 0 && v <= 1448 ? this.WALKTRACE(C, c, h, w, p, u, d, _, g, b, s, t, i, l, r, o, y, a) : (e++, n++, [new Te(e, t - e + 1, n, r - n + 1)]);
                u = this.ClipDiagonalBound(p - v, v, p, m), d = this.ClipDiagonalBound(p + v, v, p, m);
                for (let f = u; f <= d; f += 2) {
                    s = f === u || f < d && b[f - 1] >= b[f + 1] ? b[f + 1] - 1 : b[f - 1], l = s - (f - p) - _;
                    const m = s;
                    for (; s > e && l > n && this.ElementsAreEqual(s, l);) s--, l--;
                    if (b[f] = s, y && Math.abs(f - C) <= v && s <= g[f]) return i[0] = s, o[0] = l, m >= g[f] && v <= 1448 ? this.WALKTRACE(C, c, h, w, p, u, d, _, g, b, s, t, i, l, r, o, y, a) : null
                }
                if (v <= 1447) {
                    let e = new Int32Array(h - c + 2);
                    e[0] = C - c + 1, We.Copy2(g, c, e, 1, h - c + 1), this.m_forwardHistory.push(e), e = new Int32Array(d - u + 2), e[0] = p - u + 1, We.Copy2(b, u, e, 1, d - u + 1), this.m_reverseHistory.push(e)
                }
            }
        ...
        ConcatenateChanges(e, t) {
            ...
            if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
                ...
                return We.Copy(e, 0, r, 0, e.length - 1), r[e.length - 1] = n[0], We.Copy(t, 1, r, e.length, t.length - 1), r
            } {
                const n = new Array(e.length + t.length);
                return We.Copy(e, 0, n, 0, e.length), We.Copy(t, 0, n, e.length, t.length), n
            }
        }
        ChangesOverlap(e, t, n) {
            if (He.Assert(e.originalStart <= t.originalStart, "Left change is not less than or equal to right change"), He.Assert(e.modifiedStart <= t.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= t.originalStart || e.modifiedStart + e.modifiedLength >= t.modifiedStart) {
                const r = e.originalStart;
                let i = e.originalLength;
                const o = e.modifiedStart;
                let a = e.modifiedLength;
                return e.originalStart + e.originalLength >= t.originalStart && (i = t.originalStart + t.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= t.modifiedStart && (a = t.modifiedStart + t.modifiedLength - e.modifiedStart), n[0] = new Te(r, i, o, a), !0
            }
            return n[0] = null, !1
        }
    ...
    if (void 0 !== q.vscode && void 0 !== q.vscode.process) {
    ...
    } else ve = "undefined" != typeof process ? {
        get platform() {
    ...
    function tt(e, t) {
        if ("string" != typeof e) throw new et(t, "string", e)
    }
        ...
        for (let c = 0; c <= e.length; ++c) {
            ...
            if (r(l)) {
                if (a === c - 1 || 1 === s);
                    ...
                    if (i.length < 2 || 2 !== o || i.charCodeAt(i.length - 1) !== Ze || i.charCodeAt(i.length - 2) !== Ze) {
                        if (i.length > 2) {
    ...
    function at(e, t) {
        if (null === t || "object" != typeof t) throw new et("pathObject", "Object", t);
    ...
    const st = {
            resolve() {
                ...
                for (let r = arguments.length - 1; r >= -1; r--) {
                    let i;
                    if (r >= 0) {
                        if (i = r < 0 || arguments.length <= r ? void 0 : arguments[r], tt(i, "path"), 0 === i.length) continue
                    } else 0 === e.length ? i = je() : (i = Ge[`=${e}`] || je(), (void 0 === i || i.slice(0, 2).toLowerCase() !== e.toLowerCase() && i.charCodeAt(2) === Qe) && (i = `${e}\\`));
                    const o = i.length;
                    let a = 0,
                        s = "",
                        l = !1;
                    ...
                    if (1 === o) nt(c) && (a = 1, l = !0);
                        ...
                        if (l = !0, nt(i.charCodeAt(1))) {
                            let e = 2,
                                t = e;
                            for (; e < o && !nt(i.charCodeAt(e));) e++;
                            if (e < o && e !== t) {
                                const n = i.slice(t, e);
                                for (t = e; e < o && nt(i.charCodeAt(e));) e++;
                                if (e < o && e !== t) {
                                    for (t = e; e < o && !nt(i.charCodeAt(e));) e++;
                    ...
                    else it(c) && i.charCodeAt(1) === Xe && (s = i.slice(0, 2), a = 2, o > 2 && nt(i.charCodeAt(2)) && (l = !0, a = 3));
                    if (s.length > 0)
                        if (e.length > 0) {
            ...
            normalize(e) {
                ...
                if (1 === t) return rt(o) ? "\\" : e;
                if (nt(o))
                    if (i = !0, nt(e.charCodeAt(1))) {
                        let i = 2,
                            o = i;
                        for (; i < t && !nt(e.charCodeAt(i));) i++;
                        if (i < t && i !== o) {
                            const a = e.slice(o, i);
                            for (o = i; i < t && nt(e.charCodeAt(i));) i++;
                            if (i < t && i !== o) {
                                for (o = i; i < t && !nt(e.charCodeAt(i));) i++;
                ...
                else it(o) && e.charCodeAt(1) === Xe && (n = e.slice(0, 2), r = 2, t > 2 && nt(e.charCodeAt(2)) && (i = !0, r = 3));
                let a = r < t ? ot(e.slice(r), !i, "\\", nt) : "";
                return 0 !== a.length || i || (a = "."), a.length > 0 && nt(e.charCodeAt(t - 1)) && (a += "\\"), void 0 === n ? i ? `\\${a}` : a : i ? `${n}\\${a}` : `${n}${a}`
            },
            isAbsolute(e) {
                tt(e, "path");
                const t = e.length;
                ...
                return nt(n) || t > 2 && it(n) && e.charCodeAt(1) === Xe && nt(e.charCodeAt(2))
            },
            join() {
                ...
                for (let n = 0; n < arguments.length; ++n) {
                    ...
                    tt(r, "path"), r.length > 0 && (void 0 === e ? e = t = r : e += `\\${r}`)
                }
                if (void 0 === e) return ".";
                let n = !0,
                    r = 0;
                if ("string" == typeof t && nt(t.charCodeAt(0))) {
                    ++r;
                    const e = t.length;
                    e > 1 && nt(t.charCodeAt(1)) && (++r, e > 2 && (nt(t.charCodeAt(2)) ? ++r : n = !1))
                }
                if (n) {
                    for (; r < e.length && nt(e.charCodeAt(r));) r++;
                    r >= 2 && (e = `\\${e.slice(r)}`)
                }
                return st.normalize(e)
            },
            relative(e, t) {
                if (tt(e, "from"), tt(t, "to"), e === t) return "";
                const n = st.resolve(e),
                    r = st.resolve(t);
                if (n === r) return "";
                if ((e = n.toLowerCase()) === (t = r.toLowerCase())) return "";
                let i = 0;
                for (; i < e.length && e.charCodeAt(i) === Qe;) i++;
                let o = e.length;
                for (; o - 1 > i && e.charCodeAt(o - 1) === Qe;) o--;
                const a = o - i;
                let s = 0;
                for (; s < t.length && t.charCodeAt(s) === Qe;) s++;
                let l = t.length;
                for (; l - 1 > s && t.charCodeAt(l - 1) === Qe;) l--;
                const c = l - s,
                    h = a < c ? a : c;
                let u = -1,
                    d = 0;
                ...
                if (d !== h) {
                    ...
                    if (c > h) {
                        if (t.charCodeAt(s + d) === Qe) return r.slice(s + d + 1);
                        if (2 === d) return r.slice(s + d)
                    }
                    a > h && (e.charCodeAt(i + d) === Qe ? u = d : 2 === d && (u = 3)), -1 === u && (u = 0)
                }
                let f = "";
                for (d = i + u + 1; d <= o; ++d) d !== o && e.charCodeAt(d) !== Qe || (f += 0 === f.length ? ".." : "\\..");
                return s += u, f.length > 0 ? `${f}${r.slice(s,l)}` : (r.charCodeAt(s) === Qe && ++s, r.slice(s, l))
            },
            toNamespacedPath(e) {
                ...
                if (t.charCodeAt(0) === Qe) {
                    if (t.charCodeAt(1) === Qe) {
                        const e = t.charCodeAt(2);
                        if (63 !== e && e !== Ze) return `\\\\?\\UNC\\${t.slice(2)}`
                    }
                } else if (it(t.charCodeAt(0)) && t.charCodeAt(1) === Xe && t.charCodeAt(2) === Qe) return `\\\\?\\${t}`;
                return e
            },
            dirname(e) {
                tt(e, "path");
                ...
                if (1 === t) return nt(i) ? e : ".";
                if (nt(i)) {
                    if (n = r = 1, nt(e.charCodeAt(1))) {
                        let i = 2,
                            o = i;
                        for (; i < t && !nt(e.charCodeAt(i));) i++;
                        if (i < t && i !== o) {
                ...
                } else it(i) && e.charCodeAt(1) === Xe && (n = t > 2 && nt(e.charCodeAt(2)) ? 3 : 2, r = n);
                let o = -1,
                    a = !0;
                for (let n = t - 1; n >= r; --n)
                    if (nt(e.charCodeAt(n))) {
                        if (!a) {
                            o = n;
                            break
                        }
            ...
            basename(e, t) {
                void 0 !== t && tt(t, "ext"), tt(e, "path");
                let n, r = 0,
                    i = -1,
                    o = !0;
                if (e.length >= 2 && it(e.charCodeAt(0)) && e.charCodeAt(1) === Xe && (r = 2), void 0 !== t && t.length > 0 && t.length <= e.length) {
                    if (t === e) return "";
                    let a = t.length - 1,
                        s = -1;
            ...
            extname(e) {
                ...
                let t = 0,
                    ...
                    o = !0,
                    a = 0;
                e.length >= 2 && e.charCodeAt(1) === Xe && it(e.charCodeAt(0)) && (t = r = 2);
                for (let s = e.length - 1; s >= t; --s) {
                    ...
                    } else -1 === i && (o = !1, i = s + 1), t === Ze ? -1 === n ? n = s : 1 !== a && (a = 1) : -1 !== n && (a = -1)
                }
            ...
            parse(e) {
                ...
                let r = 0,
                    i = e.charCodeAt(0);
                if (1 === n) return nt(i) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
                if (nt(i)) {
                    if (r = 1, nt(e.charCodeAt(1))) {
                        let t = 2,
                            i = t;
                        for (; t < n && !nt(e.charCodeAt(t));) t++;
                        if (t < n && t !== i) {
                            for (i = t; t < n && nt(e.charCodeAt(t));) t++;
                            if (t < n && t !== i) {
                                for (i = t; t < n && !nt(e.charCodeAt(t));) t++;
                                t === n ? r = t : t !== i && (r = t + 1)
                            }
                ...
                } else if (it(i) && e.charCodeAt(1) === Xe) {
                    if (n <= 2) return t.root = t.dir = e, t;
                    if (r = 2, nt(e.charCodeAt(2))) {
                ...
                let o = -1,
                    ...
                    h = 0;
                for (; c >= r; --c)
                    if (i = e.charCodeAt(c), nt(i)) {
                        if (!l) {
                            a = c + 1;
                            break
                        }
                    } else -1 === s && (l = !1, s = c + 1), i === Ze ? -1 === o ? o = c : 1 !== h && (h = 1) : -1 !== o && (h = -1);
        ...
        lt = {
            resolve() {
                ...
                for (let n = arguments.length - 1; n >= -1 && !t; n--) {
                    const r = n >= 0 ? n < 0 || arguments.length <= n ? void 0 : arguments[n] : je();
                    tt(r, "path"), 0 !== r.length && (e = `${r}/${e}`, t = r.charCodeAt(0) === Je)
                }
                return e = ot(e, !t, "/", rt), t ? `/${e}` : e.length > 0 ? e : "."
            },
            normalize(e) {
                if (tt(e, "path"), 0 === e.length) return ".";
                const t = e.charCodeAt(0) === Je,
                    n = e.charCodeAt(e.length - 1) === Je;
                return 0 === (e = ot(e, !t, "/", rt)).length ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e)
            },
            isAbsolute: e => (tt(e, "path"), e.length > 0 && e.charCodeAt(0) === Je),
            join() {
                if (0 === arguments.length) return ".";
                let e;
                for (let t = 0; t < arguments.length; ++t) {
                    const n = t < 0 || arguments.length <= t ? void 0 : arguments[t];
                    tt(n, "path"), n.length > 0 && (void 0 === e ? e = n : e += `/${n}`)
                }
                return void 0 === e ? "." : lt.normalize(e)
            },
            relative(e, t) {
                if (tt(e, "from"), tt(t, "to"), e === t) return "";
                if ((e = lt.resolve(e)) === (t = lt.resolve(t))) return "";
                const n = e.length,
                    r = n - 1,
                    i = t.length - 1,
                    o = r < i ? r : i;
                ...
                if (s === o)
                    if (i > o) {
                        if (t.charCodeAt(1 + s) === Je) return t.slice(1 + s + 1);
                        if (0 === s) return t.slice(1 + s)
                    } else r > o && (e.charCodeAt(1 + s) === Je ? a = s : 0 === s && (a = 0));
                let l = "";
                for (s = 1 + a + 1; s <= n; ++s) s !== n && e.charCodeAt(s) !== Je || (l += 0 === l.length ? ".." : "/..");
            ...
            extname(e) {
                ...
                for (let a = e.length - 1; a >= 0; --a) {
                    ...
                    if (s !== Je) - 1 === r && (i = !1, r = a + 1), s === Ze ? -1 === t ? t = a : 1 !== o && (o = 1) : -1 !== t && (o = -1);
                    else if (!i) {
                        n = a + 1;
                        break
                    }
            ...
            parse(e) {
                ...
                for (; l >= r; --l) {
                    ...
                    if (t !== Je) - 1 === a && (s = !1, a = l + 1), t === Ze ? -1 === i ? i = l : 1 !== c && (c = 1) : -1 !== i && (c = -1);
                    else if (!s) {
                        o = l + 1;
                        break
                    }
    ...
    lt.win32 = st.win32 = st, lt.posix = st.posix = lt;
    "win32" === Ye ? st.normalize : lt.normalize, "win32" === Ye ? st.resolve : lt.resolve, "win32" === Ye ? st.relative : lt.relative, "win32" === Ye ? st.dirname : lt.dirname, "win32" === Ye ? st.basename : lt.basename, "win32" === Ye ? st.extname : lt.extname, "win32" === Ye ? st.sep : lt.sep;
    const ct = /^\w[\w\d+.-]*$/,
        ht = /^\//,
        ut = /^\/\//;
    ...
    function dt(e, t) {
        ...
        if (e.path)
            if (e.authority) {
                if (!ht.test(e.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')
            } else if (ut.test(e.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')
    }
    const ft = "",
        mt = "/",
        gt = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
    class bt {
        constructor(e, t, n, r, i) {
            ...
            "object" == typeof e ? (this.scheme = e.scheme || ft, this.authority = e.authority || ft, this.path = e.path || ft, this.query = e.query || ft, this.fragment = e.fragment || ft) : (this.scheme = function(e, t) {
                return e || t ? e : "file"
            }(e, o), this.authority = t || ft, this.path = function(e, t) {
                switch (e) {
                    case "https":
                    case "http":
                    case "file":
                        t ? t[0] !== mt && (t = mt + t) : t = mt
                }
                return t
            }(this.scheme, n || ft), this.query = r || ft, this.fragment = i || ft, dt(this, o))
        }
        static isUri(e) {
            return e instanceof bt || !!e && ("string" == typeof e.authority && "string" == typeof e.fragment && "string" == typeof e.path && "string" == typeof e.query && "string" == typeof e.scheme && "string" == typeof e.fsPath && "function" == typeof e.with && "function" == typeof e.toString)
        }
        get fsPath() {
            return vt(this, !1)
        }
        with(e) {
            ...
            return void 0 === t ? t = this.scheme : null === t && (t = ft), void 0 === n ? n = this.authority : null === n && (n = ft), void 0 === r ? r = this.path : null === r && (r = ft), void 0 === i ? i = this.query : null === i && (i = ft), void 0 === o ? o = this.fragment : null === o && (o = ft), t === this.scheme && n === this.authority && r === this.path && i === this.query && o === this.fragment ? this : new pt(t, n, r, i, o)
        }
        static parse(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            const n = gt.exec(e);
            return n ? new pt(n[2] || ft, Et(n[4] || ft), Et(n[5] || ft), Et(n[7] || ft), Et(n[9] || ft), t) : new pt(ft, ft, ft, ft, ft)
        }
        static file(e) {
            let t = ft;
            if (j && (e = e.replace(/\\/g, mt)), e[0] === mt && e[1] === mt) {
                const n = e.indexOf(mt, 2); - 1 === n ? (t = e.substring(2), e = mt) : (t = e.substring(2, n), e = e.substring(n) || mt)
            }
            return new pt("file", t, e, ft, ft)
        }
        static from(e) {
            const t = new pt(e.scheme, e.authority, e.path, e.query, e.fragment);
            return dt(t, !0), t
        }
        static joinPath(e) {
            ...
            return t = j && "file" === e.scheme ? bt.file(st.join(vt(e, !0), ...r)).path : lt.join(e.path, ...r), e.with({
                path: t
            })
        }
        toString() {
            return St(this, arguments.length > 0 && void 0 !== arguments[0] && arguments[0])
        }
        toJSON() {
            return this
        }
        static revive(e) {
            if (e) {
                if (e instanceof bt) return e; {
                    const t = new pt(e);
                    return t._formatted = e.external, t._fsPath = e._sep === Ct ? e.fsPath : null, t
                }
            }
            return e
        }
    ...
    class pt extends bt {
        ...
        toString() {
            return arguments.length > 0 && void 0 !== arguments[0] && arguments[0] ? St(this, !0) : (this._formatted || (this._formatted = St(this, !1)), this._formatted)
        }
        toJSON() {
            const e = {
                $mid: 1
            };
            return this._fsPath && (e.fsPath = this._fsPath, e._sep = Ct), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e
        }
    }
    const wt = {
        58: "%3A",
    ...
    function yt(e) {
        ...
        for (let n = 0; n < e.length; n++) {
            const r = e.charCodeAt(n);
            35 === r || 63 === r ? (void 0 === t && (t = e.substr(0, n)), t += wt[r]) : void 0 !== t && (t += e[n])
        }
        return void 0 !== t ? t : e
    }
    ...
    function St(e, t) {
        ...
        if (i && (r += i, r += ":"), (o || "file" === i) && (r += mt, r += mt), o) {
            let e = o.indexOf("@");
            if (-1 !== e) {
        ...
        return s && (r += "?", r += n(s, !1)), l && (r += "#", r += t ? l : _t(l, !1)), r
    }
    ...
    function Lt(e) {
        try {
            ...
            return e.length > 3 ? e.substr(0, 3) + Lt(e.substr(3)) : e
        }
    }
    const Nt = /(%[0-9A-Za-z][0-9A-Za-z])+/g;

    function Et(e) {
        return e.match(Nt) ? e.replace(Nt, (e => Lt(e))) : e
    }
    class At {
        constructor(e, t) {
        ...
        with() {
            ...
            return e === this.lineNumber && t === this.column ? this : new At(e, t)
        }
        delta() {
        ...
        clone() {
            return new At(this.lineNumber, this.column)
        }
        toString() {
            return "(" + this.lineNumber + "," + this.column + ")"
        }
        static lift(e) {
            return new At(e.lineNumber, e.column)
        }
    ...
    class kt {
        ...
        isEmpty() {
            return kt.isEmpty(this)
        }
        static isEmpty(e) {
            return e.startLineNumber === e.endLineNumber && e.startColumn === e.endColumn
        }
        containsPosition(e) {
            return kt.containsPosition(this, e)
        }
        ...
        containsRange(e) {
            return kt.containsRange(this, e)
        }
        ...
        strictContainsRange(e) {
            return kt.strictContainsRange(this, e)
        }
        static strictContainsRange(e, t) {
            return !(t.startLineNumber < e.startLineNumber || t.endLineNumber < e.startLineNumber) && (!(t.startLineNumber > e.endLineNumber || t.endLineNumber > e.endLineNumber) && (!(t.startLineNumber === e.startLineNumber && t.startColumn <= e.startColumn) && !(t.endLineNumber === e.endLineNumber && t.endColumn >= e.endColumn)))
        }
        plusRange(e) {
            return kt.plusRange(this, e)
        }
        ...
        intersectRanges(e) {
            return kt.intersectRanges(this, e)
        }
        static intersectRanges(e, t) {
            ...
            const a = t.startLineNumber,
                ...
                l = t.endLineNumber,
                c = t.endColumn;
            return n < a ? (n = a, r = s) : n === a && (r = Math.max(r, s)), i > l ? (i = l, o = c) : i === l && (o = Math.min(o, c)), n > i || n === i && r > o ? null : new kt(n, r, i, o)
        }
        equalsRange(e) {
            return kt.equalsRange(this, e)
        }
        ...
        getEndPosition() {
            return kt.getEndPosition(this)
        }
        static getEndPosition(e) {
            return new At(e.endLineNumber, e.endColumn)
        }
        getStartPosition() {
            return kt.getStartPosition(this)
        }
        static getStartPosition(e) {
            return new At(e.startLineNumber, e.startColumn)
        }
        toString() {
            return "[" + this.startLineNumber + "," + this.startColumn + " -> " + this.endLineNumber + "," + this.endColumn + "]"
        }
        setEndPosition(e, t) {
            return new kt(this.startLineNumber, this.startColumn, e, t)
        }
        setStartPosition(e, t) {
            return new kt(e, t, this.endLineNumber, this.endColumn)
        }
        collapseToStart() {
            return kt.collapseToStart(this)
        }
        static collapseToStart(e) {
            return new kt(e.startLineNumber, e.startColumn, e.startLineNumber, e.startColumn)
        }
        static fromPositions(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e;
            return new kt(e.lineNumber, e.column, t.lineNumber, t.column)
        }
        static lift(e) {
            return e ? new kt(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn) : null
        }
        static isIRange(e) {
    ...
    function Mt(e, t, n, r) {
        return new ze(e, t, n).ComputeDiff(r)
    }
    class Rt {
        constructor(e) {
            const t = [],
                n = [];
            for (let r = 0, i = e.length; r < i; r++) t[r] = Pt(e[r], 1), n[r] = Kt(e[r], 1);
        ...
        createCharSequence(e, t, n) {
            ...
            for (let s = t; s <= n; s++) {
                const t = this.lines[s],
                    ...
                    c = e ? this._endColumns[s] : t.length + 1;
                for (let e = l; e < c; e++) r[a] = t.charCodeAt(e - 1), i[a] = s + 1, o[a] = e, a++;
                !e && s < n && (r[a] = 10, i[a] = s + 1, o[a] = t.length + 1, a++)
            }
            return new Ot(r, i, o)
        }
    }
    ...
    class Tt {
        ...
        static createFromDiffResult(e, t, n, r, i, o, a) {
            ...
            if (0 === t.originalLength ? (s = n.getStartLineNumber(t.originalStart) - 1, l = 0) : (s = n.getStartLineNumber(t.originalStart), l = n.getEndLineNumber(t.originalStart + t.originalLength - 1)), 0 === t.modifiedLength ? (c = r.getStartLineNumber(t.modifiedStart) - 1, h = 0) : (c = r.getStartLineNumber(t.modifiedStart), h = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1)), o && t.originalLength > 0 && t.originalLength < 20 && t.modifiedLength > 0 && t.modifiedLength < 20 && i()) {
                ...
                if (o.getElements().length > 0 && s.getElements().length > 0) {
                    let e = Mt(o, s, i, !0).changes;
                    a && (e = function(e) {
                    ...
                    for (let t = 0, n = e.length; t < n; t++) u.push(xt.createFromDiffChange(e[t], o, s))
                }
            }
            return new Tt(s, l, c, h, u)
        }
    }
    class It {
        constructor(e, t, n) {
        ...
        computeDiff() {
            ...
            const e = Mt(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
                t = e.changes,
                n = e.quitEarly;
            if (this.shouldIgnoreTrimWhitespace) {
                const e = [];
                for (let n = 0, r = t.length; n < r; n++) e.push(Tt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[n], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
                return {
                    quitEarly: n,
                    changes: e
                }
            ...
            for (let e = -1, n = t.length; e < n; e++) {
                ...
                a && (r.push(Tt.createFromDiffResult(this.shouldIgnoreTrimWhitespace, a, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += a.originalLength, o += a.modifiedLength)
            }
            return {
                quitEarly: n,
                changes: r
        ...
        _pushTrimWhitespaceCharChange(e, t, n, r, i, o, a) {
            ...
            let s;
            this.shouldComputeCharChanges && (s = [new xt(t, n, t, r, i, o, i, a)]), e.push(new Tt(t, t, i, i, s))
        }
        _mergeTrimWhitespaceCharChange(e, t, n, r, i, o, a) {
            const s = e.length;
            if (0 === s) return !1;
            const l = e[s - 1];
            return 0 !== l.originalEndLineNumber && 0 !== l.modifiedEndLineNumber && (l.originalEndLineNumber + 1 === t && l.modifiedEndLineNumber + 1 === i && (l.originalEndLineNumber = t, l.modifiedEndLineNumber = i, this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new xt(t, n, t, r, i, o, i, a)), !0))
        }
    }
    ...
    class Ut {
        ...
        setValue(e, t) {
            return e = Bt(e), t = Bt(t), this.values[e] !== t && (this.values[e] = t, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0)
        }
        removeValues(e, t) {
            e = Bt(e), t = Bt(t);
            const n = this.values,
        ...
        getPrefixSum(e) {
            return e < 0 ? 0 : (e = Bt(e), this._getPrefixSum(e))
        }
        _getPrefixSum(e) {
    ...
    const Wt = function() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            t = "(-?\\d*\\.\\d\\w*)|([^";
        for (const n of Ht) e.indexOf(n) >= 0 || (t += "\\" + n);
        return t += "\\s]+)", new RegExp(t, "g")
    }();
    const $t = new S;

    function zt(e, t, n, r, i) {
        if (i || (i = c.first($t)), n.length > i.maxLen) {
            let o = e - i.maxLen / 2;
            return o < 0 ? o = 0 : r += o, zt(e, t, n = n.substring(o, e + i.maxLen / 2), r, i)
        }
        const o = Date.now(),
            a = e - 1 - r;
        let s = -1,
    ...
    class Gt {
        constructor(e) {
            const t = Ft(e);
            this._defaultValue = t, this._asciiMap = Gt._createAsciiMap(t), this._map = new Map
        }
    ...
    class Xt {
        ...
        static computeLinks(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : (null === Jt && (Jt = new Zt([
                [1, 104, 2],
                [1, 72, 2],
                [1, 102, 6],
                [1, 70, 6],
            ...
            const n = function() {
                    if (null === Qt) {
                        Qt = new Gt(0);
                        const e = " \t<>'\"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…";
                        for (let t = 0; t < e.length; t++) Qt.set(e.charCodeAt(t), 1);
                        const t = ".,;:";
                        for (let e = 0; e < t.length; e++) Qt.set(t.charCodeAt(e), 2)
                    }
                    return Qt
                }(),
                r = [];
            for (let i = 1, o = e.getLineCount(); i <= o; i++) {
                ...
                for (; s < a;) {
                    ...
                    if (13 === h) {
                        ...
                        1 === t && (r.push(Xt._createLink(n, o, i, l, s)), e = !0)
                    } else if (12 === h) {
                        let t;
                ...
                13 === h && r.push(Xt._createLink(n, o, i, l, a))
            }
            return r
        }
    }
    ...
    en.INSTANCE = new en;
    const tn = Object.freeze((function(e, t) {
    ...
    ! function(e) {
        e.isCancellationToken = function(t) {
            return t === e.None || t === e.Cancelled || (t instanceof rn || !(!t || "object" != typeof t) && ("boolean" == typeof t.isCancellationRequested && "function" == typeof t.onCancellationRequested))
        }, e.None = Object.freeze({
            isCancellationRequested: !1,
            onCancellationRequested: ee.None
        }), e.Cancelled = Object.freeze({
            isCancellationRequested: !0,
            onCancellationRequested: tn
        })
    }(nn || (nn = {}));
    class rn {
        constructor() {
        ...
        get onCancellationRequested() {
            return this._isCancelled ? tn : (this._emitter || (this._emitter = new ie), this._emitter.event)
        }
        dispose() {
    ...
    class on {
        ...
        get token() {
            return this._token || (this._token = new rn), this._token
        }
        cancel() {
            this._token ? this._token instanceof rn && this._token.cancel() : this._token = nn.Cancelled
        }
        dispose() {
            arguments.length > 0 && void 0 !== arguments[0] && arguments[0] && this.cancel(), this._parentListener && this._parentListener.dispose(), this._token ? this._token instanceof rn && this._token.dispose() : this._token = nn.None
        }
    }
    class an {
        constructor() {
    ...
    ! function() {
        ...
        for (const e of t) {
            ...
            if (r[o] || (r[o] = !0, dn[o] = a, fn[a] = o, mn[a.toLowerCase()] = o, i && (gn[o] = s, 0 !== s && 3 !== s && 5 !== s && 4 !== s && 6 !== s && 57 !== s && (bn[s] = o))), !n[s]) {
                if (n[s] = !0, !l) throw new Error(`String representation missing for key code ${s} around scan code ${a}`);
                sn.define(s, l), ln.define(s, u || l), cn.define(s, d || u || l)
            }
            c && (hn[c] = s), h && (un[h] = s)
        }
        bn[3] = 46
    ...
    function(e) {
        e.toString = function(e) {
            return sn.keyCodeToStr(e)
        }, e.fromString = function(e) {
            return sn.strToKeyCode(e)
            ...
            return ln.strToKeyCode(e) || cn.strToKeyCode(e)
    ...
    class wn extends kt {
        ...
        getPosition() {
            return new At(this.positionLineNumber, this.positionColumn)
        }
        getSelectionStart() {
            return new At(this.selectionStartLineNumber, this.selectionStartColumn)
        }
        setStartPosition(e, t) {
        ...
        static fromRange(e, t) {
            return 0 === t ? new wn(e.startLineNumber, e.startColumn, e.endLineNumber, e.endColumn) : new wn(e.endLineNumber, e.endColumn, e.startLineNumber, e.startColumn)
        }
        ...
        static createWithDirection(e, t, n, r, i) {
            return 0 === i ? new wn(e, t, n, r) : new wn(n, r, e, t)
        }
    }
    class _n {
        constructor(e, t, n) {
            this.id = e, this.definition = t, this.description = n, _n._allCodicons.push(this)
        }
        get classNames() {
        ...
        static getAll() {
            return _n._allCodicons
        }
    }
    _n._allCodicons = [], _n.add = new _n("add", {
            fontCharacter: "\\ea60"
        }), _n.plus = new _n("plus", _n.add.definition), _n.gistNew = new _n("gist-new", _n.add.definition), _n.repoCreate = new _n("repo-create", _n.add.definition), _n.lightbulb = new _n("lightbulb", {
            fontCharacter: "\\ea61"
        }), _n.lightBulb = new _n("light-bulb", {
            fontCharacter: "\\ea61"
        }), _n.repo = new _n("repo", {
            fontCharacter: "\\ea62"
        }), _n.repoDelete = new _n("repo-delete", {
            fontCharacter: "\\ea62"
        }), _n.gistFork = new _n("gist-fork", {
            fontCharacter: "\\ea63"
        }), _n.repoForked = new _n("repo-forked", {
            fontCharacter: "\\ea63"
        }), _n.gitPullRequest = new _n("git-pull-request", {
            fontCharacter: "\\ea64"
        }), _n.gitPullRequestAbandoned = new _n("git-pull-request-abandoned", {
            fontCharacter: "\\ea64"
        }), _n.recordKeys = new _n("record-keys", {
            fontCharacter: "\\ea65"
        }), _n.keyboard = new _n("keyboard", {
            fontCharacter: "\\ea65"
        }), _n.tag = new _n("tag", {
            fontCharacter: "\\ea66"
        }), _n.tagAdd = new _n("tag-add", {
            fontCharacter: "\\ea66"
        }), _n.tagRemove = new _n("tag-remove", {
            fontCharacter: "\\ea66"
        }), _n.person = new _n("person", {
            fontCharacter: "\\ea67"
        }), _n.personFollow = new _n("person-follow", {
            fontCharacter: "\\ea67"
        }), _n.personOutline = new _n("person-outline", {
            fontCharacter: "\\ea67"
        }), _n.personFilled = new _n("person-filled", {
            fontCharacter: "\\ea67"
        }), _n.gitBranch = new _n("git-branch", {
            fontCharacter: "\\ea68"
        }), _n.gitBranchCreate = new _n("git-branch-create", {
            fontCharacter: "\\ea68"
        }), _n.gitBranchDelete = new _n("git-branch-delete", {
            fontCharacter: "\\ea68"
        }), _n.sourceControl = new _n("source-control", {
            fontCharacter: "\\ea68"
        }), _n.mirror = new _n("mirror", {
            fontCharacter: "\\ea69"
        }), _n.mirrorPublic = new _n("mirror-public", {
            fontCharacter: "\\ea69"
        }), _n.star = new _n("star", {
            fontCharacter: "\\ea6a"
        }), _n.starAdd = new _n("star-add", {
            fontCharacter: "\\ea6a"
        }), _n.starDelete = new _n("star-delete", {
            fontCharacter: "\\ea6a"
        }), _n.starEmpty = new _n("star-empty", {
            fontCharacter: "\\ea6a"
        }), _n.comment = new _n("comment", {
            fontCharacter: "\\ea6b"
        }), _n.commentAdd = new _n("comment-add", {
            fontCharacter: "\\ea6b"
        }), _n.alert = new _n("alert", {
            fontCharacter: "\\ea6c"
        }), _n.warning = new _n("warning", {
            fontCharacter: "\\ea6c"
        }), _n.search = new _n("search", {
            fontCharacter: "\\ea6d"
        }), _n.searchSave = new _n("search-save", {
            fontCharacter: "\\ea6d"
        }), _n.logOut = new _n("log-out", {
            fontCharacter: "\\ea6e"
        }), _n.signOut = new _n("sign-out", {
            fontCharacter: "\\ea6e"
        }), _n.logIn = new _n("log-in", {
            fontCharacter: "\\ea6f"
        }), _n.signIn = new _n("sign-in", {
            fontCharacter: "\\ea6f"
        }), _n.eye = new _n("eye", {
            fontCharacter: "\\ea70"
        }), _n.eyeUnwatch = new _n("eye-unwatch", {
            fontCharacter: "\\ea70"
        }), _n.eyeWatch = new _n("eye-watch", {
            fontCharacter: "\\ea70"
        }), _n.circleFilled = new _n("circle-filled", {
            fontCharacter: "\\ea71"
        }), _n.primitiveDot = new _n("primitive-dot", {
            fontCharacter: "\\ea71"
        }), _n.closeDirty = new _n("close-dirty", {
            fontCharacter: "\\ea71"
        }), _n.debugBreakpoint = new _n("debug-breakpoint", {
            fontCharacter: "\\ea71"
        }), _n.debugBreakpointDisabled = new _n("debug-breakpoint-disabled", {
            fontCharacter: "\\ea71"
        }), _n.debugHint = new _n("debug-hint", {
            fontCharacter: "\\ea71"
        }), _n.primitiveSquare = new _n("primitive-square", {
            fontCharacter: "\\ea72"
        }), _n.edit = new _n("edit", {
            fontCharacter: "\\ea73"
        }), _n.pencil = new _n("pencil", {
            fontCharacter: "\\ea73"
        }), _n.info = new _n("info", {
            fontCharacter: "\\ea74"
        }), _n.issueOpened = new _n("issue-opened", {
            fontCharacter: "\\ea74"
        }), _n.gistPrivate = new _n("gist-private", {
            fontCharacter: "\\ea75"
        }), _n.gitForkPrivate = new _n("git-fork-private", {
            fontCharacter: "\\ea75"
        }), _n.lock = new _n("lock", {
            fontCharacter: "\\ea75"
        }), _n.mirrorPrivate = new _n("mirror-private", {
            fontCharacter: "\\ea75"
        }), _n.close = new _n("close", {
            fontCharacter: "\\ea76"
        }), _n.removeClose = new _n("remove-close", {
            fontCharacter: "\\ea76"
        }), _n.x = new _n("x", {
            fontCharacter: "\\ea76"
        }), _n.repoSync = new _n("repo-sync", {
            fontCharacter: "\\ea77"
        }), _n.sync = new _n("sync", {
            fontCharacter: "\\ea77"
        }), _n.clone = new _n("clone", {
            fontCharacter: "\\ea78"
        }), _n.desktopDownload = new _n("desktop-download", {
            fontCharacter: "\\ea78"
        }), _n.beaker = new _n("beaker", {
            fontCharacter: "\\ea79"
        }), _n.microscope = new _n("microscope", {
            fontCharacter: "\\ea79"
        }), _n.vm = new _n("vm", {
            fontCharacter: "\\ea7a"
        }), _n.deviceDesktop = new _n("device-desktop", {
            fontCharacter: "\\ea7a"
        }), _n.file = new _n("file", {
            fontCharacter: "\\ea7b"
        }), _n.fileText = new _n("file-text", {
            fontCharacter: "\\ea7b"
        }), _n.more = new _n("more", {
            fontCharacter: "\\ea7c"
        }), _n.ellipsis = new _n("ellipsis", {
            fontCharacter: "\\ea7c"
        }), _n.kebabHorizontal = new _n("kebab-horizontal", {
            fontCharacter: "\\ea7c"
        }), _n.mailReply = new _n("mail-reply", {
            fontCharacter: "\\ea7d"
        }), _n.reply = new _n("reply", {
            fontCharacter: "\\ea7d"
        }), _n.organization = new _n("organization", {
            fontCharacter: "\\ea7e"
        }), _n.organizationFilled = new _n("organization-filled", {
            fontCharacter: "\\ea7e"
        }), _n.organizationOutline = new _n("organization-outline", {
            fontCharacter: "\\ea7e"
        }), _n.newFile = new _n("new-file", {
            fontCharacter: "\\ea7f"
        }), _n.fileAdd = new _n("file-add", {
            fontCharacter: "\\ea7f"
        }), _n.newFolder = new _n("new-folder", {
            fontCharacter: "\\ea80"
        }), _n.fileDirectoryCreate = new _n("file-directory-create", {
            fontCharacter: "\\ea80"
        }), _n.trash = new _n("trash", {
            fontCharacter: "\\ea81"
        }), _n.trashcan = new _n("trashcan", {
            fontCharacter: "\\ea81"
        }), _n.history = new _n("history", {
            fontCharacter: "\\ea82"
        }), _n.clock = new _n("clock", {
            fontCharacter: "\\ea82"
        }), _n.folder = new _n("folder", {
            fontCharacter: "\\ea83"
        }), _n.fileDirectory = new _n("file-directory", {
            fontCharacter: "\\ea83"
        }), _n.symbolFolder = new _n("symbol-folder", {
            fontCharacter: "\\ea83"
        }), _n.logoGithub = new _n("logo-github", {
            fontCharacter: "\\ea84"
        }), _n.markGithub = new _n("mark-github", {
            fontCharacter: "\\ea84"
        }), _n.github = new _n("github", {
            fontCharacter: "\\ea84"
        }), _n.terminal = new _n("terminal", {
            fontCharacter: "\\ea85"
        }), _n.console = new _n("console", {
            fontCharacter: "\\ea85"
        }), _n.repl = new _n("repl", {
            fontCharacter: "\\ea85"
        }), _n.zap = new _n("zap", {
            fontCharacter: "\\ea86"
        }), _n.symbolEvent = new _n("symbol-event", {
            fontCharacter: "\\ea86"
        }), _n.error = new _n("error", {
            fontCharacter: "\\ea87"
        }), _n.stop = new _n("stop", {
            fontCharacter: "\\ea87"
        }), _n.variable = new _n("variable", {
            fontCharacter: "\\ea88"
        }), _n.symbolVariable = new _n("symbol-variable", {
            fontCharacter: "\\ea88"
        }), _n.array = new _n("array", {
            fontCharacter: "\\ea8a"
        }), _n.symbolArray = new _n("symbol-array", {
            fontCharacter: "\\ea8a"
        }), _n.symbolModule = new _n("symbol-module", {
            fontCharacter: "\\ea8b"
        }), _n.symbolPackage = new _n("symbol-package", {
            fontCharacter: "\\ea8b"
        }), _n.symbolNamespace = new _n("symbol-namespace", {
            fontCharacter: "\\ea8b"
        }), _n.symbolObject = new _n("symbol-object", {
            fontCharacter: "\\ea8b"
        }), _n.symbolMethod = new _n("symbol-method", {
            fontCharacter: "\\ea8c"
        }), _n.symbolFunction = new _n("symbol-function", {
            fontCharacter: "\\ea8c"
        }), _n.symbolConstructor = new _n("symbol-constructor", {
            fontCharacter: "\\ea8c"
        }), _n.symbolBoolean = new _n("symbol-boolean", {
            fontCharacter: "\\ea8f"
        }), _n.symbolNull = new _n("symbol-null", {
            fontCharacter: "\\ea8f"
        }), _n.symbolNumeric = new _n("symbol-numeric", {
            fontCharacter: "\\ea90"
        }), _n.symbolNumber = new _n("symbol-number", {
            fontCharacter: "\\ea90"
        }), _n.symbolStructure = new _n("symbol-structure", {
            fontCharacter: "\\ea91"
        }), _n.symbolStruct = new _n("symbol-struct", {
            fontCharacter: "\\ea91"
        }), _n.symbolParameter = new _n("symbol-parameter", {
            fontCharacter: "\\ea92"
        }), _n.symbolTypeParameter = new _n("symbol-type-parameter", {
            fontCharacter: "\\ea92"
        }), _n.symbolKey = new _n("symbol-key", {
            fontCharacter: "\\ea93"
        }), _n.symbolText = new _n("symbol-text", {
            fontCharacter: "\\ea93"
        }), _n.symbolReference = new _n("symbol-reference", {
            fontCharacter: "\\ea94"
        }), _n.goToFile = new _n("go-to-file", {
            fontCharacter: "\\ea94"
        }), _n.symbolEnum = new _n("symbol-enum", {
            fontCharacter: "\\ea95"
        }), _n.symbolValue = new _n("symbol-value", {
            fontCharacter: "\\ea95"
        }), _n.symbolRuler = new _n("symbol-ruler", {
            fontCharacter: "\\ea96"
        }), _n.symbolUnit = new _n("symbol-unit", {
            fontCharacter: "\\ea96"
        }), _n.activateBreakpoints = new _n("activate-breakpoints", {
            fontCharacter: "\\ea97"
        }), _n.archive = new _n("archive", {
            fontCharacter: "\\ea98"
        }), _n.arrowBoth = new _n("arrow-both", {
            fontCharacter: "\\ea99"
        }), _n.arrowDown = new _n("arrow-down", {
            fontCharacter: "\\ea9a"
        }), _n.arrowLeft = new _n("arrow-left", {
            fontCharacter: "\\ea9b"
        }), _n.arrowRight = new _n("arrow-right", {
            fontCharacter: "\\ea9c"
        }), _n.arrowSmallDown = new _n("arrow-small-down", {
            fontCharacter: "\\ea9d"
        }), _n.arrowSmallLeft = new _n("arrow-small-left", {
            fontCharacter: "\\ea9e"
        }), _n.arrowSmallRight = new _n("arrow-small-right", {
            fontCharacter: "\\ea9f"
        }), _n.arrowSmallUp = new _n("arrow-small-up", {
            fontCharacter: "\\eaa0"
        }), _n.arrowUp = new _n("arrow-up", {
            fontCharacter: "\\eaa1"
        }), _n.bell = new _n("bell", {
            fontCharacter: "\\eaa2"
        }), _n.bold = new _n("bold", {
            ...
            fontCharacter: "\\eaa4"
        }), _n.bookmark = new _n("bookmark", {
            fontCharacter: "\\eaa5"
        }), _n.debugBreakpointConditionalUnverified = new _n("debug-breakpoint-conditional-unverified", {
            fontCharacter: "\\eaa6"
        }), _n.debugBreakpointConditional = new _n("debug-breakpoint-conditional", {
            fontCharacter: "\\eaa7"
        }), _n.debugBreakpointConditionalDisabled = new _n("debug-breakpoint-conditional-disabled", {
            fontCharacter: "\\eaa7"
        }), _n.debugBreakpointDataUnverified = new _n("debug-breakpoint-data-unverified", {
            fontCharacter: "\\eaa8"
        }), _n.debugBreakpointData = new _n("debug-breakpoint-data", {
            fontCharacter: "\\eaa9"
        }), _n.debugBreakpointDataDisabled = new _n("debug-breakpoint-data-disabled", {
            fontCharacter: "\\eaa9"
        }), _n.debugBreakpointLogUnverified = new _n("debug-breakpoint-log-unverified", {
            fontCharacter: "\\eaaa"
        }), _n.debugBreakpointLog = new _n("debug-breakpoint-log", {
            fontCharacter: "\\eaab"
        }), _n.debugBreakpointLogDisabled = new _n("debug-breakpoint-log-disabled", {
            fontCharacter: "\\eaab"
        }), _n.briefcase = new _n("briefcase", {
            fontCharacter: "\\eaac"
        }), _n.broadcast = new _n("broadcast", {
            fontCharacter: "\\eaad"
        }), _n.browser = new _n("browser", {
            fontCharacter: "\\eaae"
        }), _n.bug = new _n("bug", {
            fontCharacter: "\\eaaf"
        }), _n.calendar = new _n("calendar", {
            fontCharacter: "\\eab0"
        }), _n.caseSensitive = new _n("case-sensitive", {
            fontCharacter: "\\eab1"
        }), _n.check = new _n("check", {
            fontCharacter: "\\eab2"
        }), _n.checklist = new _n("checklist", {
            fontCharacter: "\\eab3"
        }), _n.chevronDown = new _n("chevron-down", {
            fontCharacter: "\\eab4"
        }), _n.dropDownButton = new _n("drop-down-button", _n.chevronDown.definition), _n.chevronLeft = new _n("chevron-left", {
            fontCharacter: "\\eab5"
        }), _n.chevronRight = new _n("chevron-right", {
            fontCharacter: "\\eab6"
        }), _n.chevronUp = new _n("chevron-up", {
            fontCharacter: "\\eab7"
        }), _n.chromeClose = new _n("chrome-close", {
            fontCharacter: "\\eab8"
        }), _n.chromeMaximize = new _n("chrome-maximize", {
            fontCharacter: "\\eab9"
        }), _n.chromeMinimize = new _n("chrome-minimize", {
            fontCharacter: "\\eaba"
        }), _n.chromeRestore = new _n("chrome-restore", {
            fontCharacter: "\\eabb"
        }), _n.circleOutline = new _n("circle-outline", {
            fontCharacter: "\\eabc"
        }), _n.debugBreakpointUnverified = new _n("debug-breakpoint-unverified", {
            fontCharacter: "\\eabc"
        }), _n.circleSlash = new _n("circle-slash", {
            fontCharacter: "\\eabd"
        }), _n.circuitBoard = new _n("circuit-board", {
            fontCharacter: "\\eabe"
        }), _n.clearAll = new _n("clear-all", {
            fontCharacter: "\\eabf"
        }), _n.clippy = new _n("clippy", {
            fontCharacter: "\\eac0"
        }), _n.closeAll = new _n("close-all", {
            fontCharacter: "\\eac1"
        }), _n.cloudDownload = new _n("cloud-download", {
            fontCharacter: "\\eac2"
        }), _n.cloudUpload = new _n("cloud-upload", {
            fontCharacter: "\\eac3"
        }), _n.code = new _n("code", {
            fontCharacter: "\\eac4"
        }), _n.collapseAll = new _n("collapse-all", {
            fontCharacter: "\\eac5"
        }), _n.colorMode = new _n("color-mode", {
            fontCharacter: "\\eac6"
        }), _n.commentDiscussion = new _n("comment-discussion", {
            fontCharacter: "\\eac7"
        }), _n.compareChanges = new _n("compare-changes", {
            fontCharacter: "\\eafd"
        }), _n.creditCard = new _n("credit-card", {
            fontCharacter: "\\eac9"
        }), _n.dash = new _n("dash", {
            fontCharacter: "\\eacc"
        }), _n.dashboard = new _n("dashboard", {
            fontCharacter: "\\eacd"
        }), _n.database = new _n("database", {
            fontCharacter: "\\eace"
        }), _n.debugContinue = new _n("debug-continue", {
            fontCharacter: "\\eacf"
        }), _n.debugDisconnect = new _n("debug-disconnect", {
            fontCharacter: "\\ead0"
        }), _n.debugPause = new _n("debug-pause", {
            fontCharacter: "\\ead1"
        }), _n.debugRestart = new _n("debug-restart", {
            fontCharacter: "\\ead2"
        }), _n.debugStart = new _n("debug-start", {
            fontCharacter: "\\ead3"
        }), _n.debugStepInto = new _n("debug-step-into", {
            fontCharacter: "\\ead4"
        }), _n.debugStepOut = new _n("debug-step-out", {
            fontCharacter: "\\ead5"
        }), _n.debugStepOver = new _n("debug-step-over", {
            fontCharacter: "\\ead6"
        }), _n.debugStop = new _n("debug-stop", {
            fontCharacter: "\\ead7"
        }), _n.debug = new _n("debug", {
            fontCharacter: "\\ead8"
        }), _n.deviceCameraVideo = new _n("device-camera-video", {
            fontCharacter: "\\ead9"
        }), _n.deviceCamera = new _n("device-camera", {
            fontCharacter: "\\eada"
        }), _n.deviceMobile = new _n("device-mobile", {
            fontCharacter: "\\eadb"
        }), _n.diffAdded = new _n("diff-added", {
            fontCharacter: "\\eadc"
        }), _n.diffIgnored = new _n("diff-ignored", {
            fontCharacter: "\\eadd"
        }), _n.diffModified = new _n("diff-modified", {
            fontCharacter: "\\eade"
        }), _n.diffRemoved = new _n("diff-removed", {
            fontCharacter: "\\eadf"
        }), _n.diffRenamed = new _n("diff-renamed", {
            fontCharacter: "\\eae0"
        }), _n.diff = new _n("diff", {
            fontCharacter: "\\eae1"
        }), _n.discard = new _n("discard", {
            fontCharacter: "\\eae2"
        }), _n.editorLayout = new _n("editor-layout", {
            fontCharacter: "\\eae3"
        }), _n.emptyWindow = new _n("empty-window", {
            fontCharacter: "\\eae4"
        }), _n.exclude = new _n("exclude", {
            fontCharacter: "\\eae5"
        }), _n.extensions = new _n("extensions", {
            fontCharacter: "\\eae6"
        }), _n.eyeClosed = new _n("eye-closed", {
            fontCharacter: "\\eae7"
        }), _n.fileBinary = new _n("file-binary", {
            fontCharacter: "\\eae8"
        }), _n.fileCode = new _n("file-code", {
            fontCharacter: "\\eae9"
        }), _n.fileMedia = new _n("file-media", {
            fontCharacter: "\\eaea"
        }), _n.filePdf = new _n("file-pdf", {
            fontCharacter: "\\eaeb"
        }), _n.fileSubmodule = new _n("file-submodule", {
            fontCharacter: "\\eaec"
        }), _n.fileSymlinkDirectory = new _n("file-symlink-directory", {
            fontCharacter: "\\eaed"
        }), _n.fileSymlinkFile = new _n("file-symlink-file", {
            fontCharacter: "\\eaee"
        }), _n.fileZip = new _n("file-zip", {
            fontCharacter: "\\eaef"
        }), _n.files = new _n("files", {
            fontCharacter: "\\eaf0"
        }), _n.filter = new _n("filter", {
            fontCharacter: "\\eaf1"
        }), _n.flame = new _n("flame", {
            fontCharacter: "\\eaf2"
        }), _n.foldDown = new _n("fold-down", {
            fontCharacter: "\\eaf3"
        }), _n.foldUp = new _n("fold-up", {
            fontCharacter: "\\eaf4"
        }), _n.fold = new _n("fold", {
            fontCharacter: "\\eaf5"
        }), _n.folderActive = new _n("folder-active", {
            fontCharacter: "\\eaf6"
        }), _n.folderOpened = new _n("folder-opened", {
            fontCharacter: "\\eaf7"
        }), _n.gear = new _n("gear", {
            fontCharacter: "\\eaf8"
        }), _n.gift = new _n("gift", {
            fontCharacter: "\\eaf9"
        }), _n.gistSecret = new _n("gist-secret", {
            fontCharacter: "\\eafa"
        }), _n.gist = new _n("gist", {
            fontCharacter: "\\eafb"
        }), _n.gitCommit = new _n("git-commit", {
            fontCharacter: "\\eafc"
        }), _n.gitCompare = new _n("git-compare", {
            fontCharacter: "\\eafd"
        }), _n.gitMerge = new _n("git-merge", {
            fontCharacter: "\\eafe"
        }), _n.githubAction = new _n("github-action", {
            fontCharacter: "\\eaff"
        }), _n.githubAlt = new _n("github-alt", {
            fontCharacter: "\\eb00"
        }), _n.globe = new _n("globe", {
            fontCharacter: "\\eb01"
        }), _n.grabber = new _n("grabber", {
            fontCharacter: "\\eb02"
        }), _n.graph = new _n("graph", {
            fontCharacter: "\\eb03"
        }), _n.gripper = new _n("gripper", {
            fontCharacter: "\\eb04"
        }), _n.heart = new _n("heart", {
            fontCharacter: "\\eb05"
        }), _n.home = new _n("home", {
            fontCharacter: "\\eb06"
        }), _n.horizontalRule = new _n("horizontal-rule", {
            fontCharacter: "\\eb07"
        }), _n.hubot = new _n("hubot", {
            fontCharacter: "\\eb08"
        }), _n.inbox = new _n("inbox", {
            fontCharacter: "\\eb09"
        }), _n.issueClosed = new _n("issue-closed", {
            fontCharacter: "\\eba4"
        }), _n.issueReopened = new _n("issue-reopened", {
            fontCharacter: "\\eb0b"
        }), _n.issues = new _n("issues", {
            fontCharacter: "\\eb0c"
        }), _n.italic = new _n("italic", {
            fontCharacter: "\\eb0d"
        }), _n.jersey = new _n("jersey", {
            fontCharacter: "\\eb0e"
        }), _n.json = new _n("json", {
            fontCharacter: "\\eb0f"
        }), _n.kebabVertical = new _n("kebab-vertical", {
            fontCharacter: "\\eb10"
        }), _n.key = new _n("key", {
            fontCharacter: "\\eb11"
        }), _n.law = new _n("law", {
            fontCharacter: "\\eb12"
        }), _n.lightbulbAutofix = new _n("lightbulb-autofix", {
            fontCharacter: "\\eb13"
        }), _n.linkExternal = new _n("link-external", {
            fontCharacter: "\\eb14"
        }), _n.link = new _n("link", {
            fontCharacter: "\\eb15"
        }), _n.listOrdered = new _n("list-ordered", {
            fontCharacter: "\\eb16"
        }), _n.listUnordered = new _n("list-unordered", {
            fontCharacter: "\\eb17"
        }), _n.liveShare = new _n("live-share", {
            fontCharacter: "\\eb18"
        }), _n.loading = new _n("loading", {
            fontCharacter: "\\eb19"
        }), _n.location = new _n("location", {
            fontCharacter: "\\eb1a"
        }), _n.mailRead = new _n("mail-read", {
            fontCharacter: "\\eb1b"
        }), _n.mail = new _n("mail", {
            fontCharacter: "\\eb1c"
        }), _n.markdown = new _n("markdown", {
            fontCharacter: "\\eb1d"
        }), _n.megaphone = new _n("megaphone", {
            fontCharacter: "\\eb1e"
        }), _n.mention = new _n("mention", {
            fontCharacter: "\\eb1f"
        }), _n.milestone = new _n("milestone", {
            fontCharacter: "\\eb20"
        }), _n.mortarBoard = new _n("mortar-board", {
            fontCharacter: "\\eb21"
        }), _n.move = new _n("move", {
            fontCharacter: "\\eb22"
        }), _n.multipleWindows = new _n("multiple-windows", {
            fontCharacter: "\\eb23"
        }), _n.mute = new _n("mute", {
            fontCharacter: "\\eb24"
        }), _n.noNewline = new _n("no-newline", {
            fontCharacter: "\\eb25"
        }), _n.note = new _n("note", {
            fontCharacter: "\\eb26"
        }), _n.octoface = new _n("octoface", {
            fontCharacter: "\\eb27"
        }), _n.openPreview = new _n("open-preview", {
            fontCharacter: "\\eb28"
        }), _n.package_ = new _n("package", {
            fontCharacter: "\\eb29"
        }), _n.paintcan = new _n("paintcan", {
            fontCharacter: "\\eb2a"
        }), _n.pin = new _n("pin", {
            fontCharacter: "\\eb2b"
        }), _n.play = new _n("play", {
            ...
            fontCharacter: "\\eb2d"
        }), _n.preserveCase = new _n("preserve-case", {
            fontCharacter: "\\eb2e"
        }), _n.preview = new _n("preview", {
            fontCharacter: "\\eb2f"
        }), _n.project = new _n("project", {
            fontCharacter: "\\eb30"
        }), _n.pulse = new _n("pulse", {
            fontCharacter: "\\eb31"
        }), _n.question = new _n("question", {
            fontCharacter: "\\eb32"
        }), _n.quote = new _n("quote", {
            fontCharacter: "\\eb33"
        }), _n.radioTower = new _n("radio-tower", {
            fontCharacter: "\\eb34"
        }), _n.reactions = new _n("reactions", {
            fontCharacter: "\\eb35"
        }), _n.references = new _n("references", {
            fontCharacter: "\\eb36"
        }), _n.refresh = new _n("refresh", {
            fontCharacter: "\\eb37"
        }), _n.regex = new _n("regex", {
            fontCharacter: "\\eb38"
        }), _n.remoteExplorer = new _n("remote-explorer", {
            fontCharacter: "\\eb39"
        }), _n.remote = new _n("remote", {
            fontCharacter: "\\eb3a"
        }), _n.remove = new _n("remove", {
            fontCharacter: "\\eb3b"
        }), _n.replaceAll = new _n("replace-all", {
            fontCharacter: "\\eb3c"
        }), _n.replace = new _n("replace", {
            fontCharacter: "\\eb3d"
        }), _n.repoClone = new _n("repo-clone", {
            fontCharacter: "\\eb3e"
        }), _n.repoForcePush = new _n("repo-force-push", {
            fontCharacter: "\\eb3f"
        }), _n.repoPull = new _n("repo-pull", {
            fontCharacter: "\\eb40"
        }), _n.repoPush = new _n("repo-push", {
            fontCharacter: "\\eb41"
        }), _n.report = new _n("report", {
            fontCharacter: "\\eb42"
        }), _n.requestChanges = new _n("request-changes", {
            fontCharacter: "\\eb43"
        }), _n.rocket = new _n("rocket", {
            fontCharacter: "\\eb44"
        }), _n.rootFolderOpened = new _n("root-folder-opened", {
            fontCharacter: "\\eb45"
        }), _n.rootFolder = new _n("root-folder", {
            fontCharacter: "\\eb46"
        }), _n.rss = new _n("rss", {
            fontCharacter: "\\eb47"
        }), _n.ruby = new _n("ruby", {
            fontCharacter: "\\eb48"
        }), _n.saveAll = new _n("save-all", {
            fontCharacter: "\\eb49"
        }), _n.saveAs = new _n("save-as", {
            fontCharacter: "\\eb4a"
        }), _n.save = new _n("save", {
            fontCharacter: "\\eb4b"
        }), _n.screenFull = new _n("screen-full", {
            fontCharacter: "\\eb4c"
        }), _n.screenNormal = new _n("screen-normal", {
            fontCharacter: "\\eb4d"
        }), _n.searchStop = new _n("search-stop", {
            fontCharacter: "\\eb4e"
        }), _n.server = new _n("server", {
            fontCharacter: "\\eb50"
        }), _n.settingsGear = new _n("settings-gear", {
            fontCharacter: "\\eb51"
        }), _n.settings = new _n("settings", {
            fontCharacter: "\\eb52"
        }), _n.shield = new _n("shield", {
            fontCharacter: "\\eb53"
        }), _n.smiley = new _n("smiley", {
            fontCharacter: "\\eb54"
        }), _n.sortPrecedence = new _n("sort-precedence", {
            fontCharacter: "\\eb55"
        }), _n.splitHorizontal = new _n("split-horizontal", {
            fontCharacter: "\\eb56"
        }), _n.splitVertical = new _n("split-vertical", {
            fontCharacter: "\\eb57"
        }), _n.squirrel = new _n("squirrel", {
            fontCharacter: "\\eb58"
        }), _n.starFull = new _n("star-full", {
            fontCharacter: "\\eb59"
        }), _n.starHalf = new _n("star-half", {
            fontCharacter: "\\eb5a"
        }), _n.symbolClass = new _n("symbol-class", {
            fontCharacter: "\\eb5b"
        }), _n.symbolColor = new _n("symbol-color", {
            fontCharacter: "\\eb5c"
        }), _n.symbolCustomColor = new _n("symbol-customcolor", {
            fontCharacter: "\\eb5c"
        }), _n.symbolConstant = new _n("symbol-constant", {
            fontCharacter: "\\eb5d"
        }), _n.symbolEnumMember = new _n("symbol-enum-member", {
            fontCharacter: "\\eb5e"
        }), _n.symbolField = new _n("symbol-field", {
            fontCharacter: "\\eb5f"
        }), _n.symbolFile = new _n("symbol-file", {
            fontCharacter: "\\eb60"
        }), _n.symbolInterface = new _n("symbol-interface", {
            fontCharacter: "\\eb61"
        }), _n.symbolKeyword = new _n("symbol-keyword", {
            fontCharacter: "\\eb62"
        }), _n.symbolMisc = new _n("symbol-misc", {
            fontCharacter: "\\eb63"
        }), _n.symbolOperator = new _n("symbol-operator", {
            fontCharacter: "\\eb64"
        }), _n.symbolProperty = new _n("symbol-property", {
            fontCharacter: "\\eb65"
        }), _n.wrench = new _n("wrench", {
            fontCharacter: "\\eb65"
        }), _n.wrenchSubaction = new _n("wrench-subaction", {
            fontCharacter: "\\eb65"
        }), _n.symbolSnippet = new _n("symbol-snippet", {
            fontCharacter: "\\eb66"
        }), _n.tasklist = new _n("tasklist", {
            fontCharacter: "\\eb67"
        }), _n.telescope = new _n("telescope", {
            fontCharacter: "\\eb68"
        }), _n.textSize = new _n("text-size", {
            fontCharacter: "\\eb69"
        }), _n.threeBars = new _n("three-bars", {
            fontCharacter: "\\eb6a"
        }), _n.thumbsdown = new _n("thumbsdown", {
            fontCharacter: "\\eb6b"
        }), _n.thumbsup = new _n("thumbsup", {
            fontCharacter: "\\eb6c"
        }), _n.tools = new _n("tools", {
            fontCharacter: "\\eb6d"
        }), _n.triangleDown = new _n("triangle-down", {
            fontCharacter: "\\eb6e"
        }), _n.triangleLeft = new _n("triangle-left", {
            fontCharacter: "\\eb6f"
        }), _n.triangleRight = new _n("triangle-right", {
            fontCharacter: "\\eb70"
        }), _n.triangleUp = new _n("triangle-up", {
            fontCharacter: "\\eb71"
        }), _n.twitter = new _n("twitter", {
            fontCharacter: "\\eb72"
        }), _n.unfold = new _n("unfold", {
            fontCharacter: "\\eb73"
        }), _n.unlock = new _n("unlock", {
            fontCharacter: "\\eb74"
        }), _n.unmute = new _n("unmute", {
            fontCharacter: "\\eb75"
        }), _n.unverified = new _n("unverified", {
            fontCharacter: "\\eb76"
        }), _n.verified = new _n("verified", {
            fontCharacter: "\\eb77"
        }), _n.versions = new _n("versions", {
            fontCharacter: "\\eb78"
        }), _n.vmActive = new _n("vm-active", {
            fontCharacter: "\\eb79"
        }), _n.vmOutline = new _n("vm-outline", {
            fontCharacter: "\\eb7a"
        }), _n.vmRunning = new _n("vm-running", {
            fontCharacter: "\\eb7b"
        }), _n.watch = new _n("watch", {
            fontCharacter: "\\eb7c"
        }), _n.whitespace = new _n("whitespace", {
            fontCharacter: "\\eb7d"
        }), _n.wholeWord = new _n("whole-word", {
            fontCharacter: "\\eb7e"
        }), _n.window = new _n("window", {
            fontCharacter: "\\eb7f"
        }), _n.wordWrap = new _n("word-wrap", {
            fontCharacter: "\\eb80"
        }), _n.zoomIn = new _n("zoom-in", {
            fontCharacter: "\\eb81"
        }), _n.zoomOut = new _n("zoom-out", {
            fontCharacter: "\\eb82"
        }), _n.listFilter = new _n("list-filter", {
            fontCharacter: "\\eb83"
        }), _n.listFlat = new _n("list-flat", {
            fontCharacter: "\\eb84"
        }), _n.listSelection = new _n("list-selection", {
            fontCharacter: "\\eb85"
        }), _n.selection = new _n("selection", {
            fontCharacter: "\\eb85"
        }), _n.listTree = new _n("list-tree", {
            fontCharacter: "\\eb86"
        }), _n.debugBreakpointFunctionUnverified = new _n("debug-breakpoint-function-unverified", {
            fontCharacter: "\\eb87"
        }), _n.debugBreakpointFunction = new _n("debug-breakpoint-function", {
            fontCharacter: "\\eb88"
        }), _n.debugBreakpointFunctionDisabled = new _n("debug-breakpoint-function-disabled", {
            fontCharacter: "\\eb88"
        }), _n.debugStackframeActive = new _n("debug-stackframe-active", {
            fontCharacter: "\\eb89"
        }), _n.circleSmallFilled = new _n("circle-small-filled", {
            fontCharacter: "\\eb8a"
        }), _n.debugStackframeDot = new _n("debug-stackframe-dot", _n.circleSmallFilled.definition), _n.debugStackframe = new _n("debug-stackframe", {
            fontCharacter: "\\eb8b"
        }), _n.debugStackframeFocused = new _n("debug-stackframe-focused", {
            fontCharacter: "\\eb8b"
        }), _n.debugBreakpointUnsupported = new _n("debug-breakpoint-unsupported", {
            fontCharacter: "\\eb8c"
        }), _n.symbolString = new _n("symbol-string", {
            fontCharacter: "\\eb8d"
        }), _n.debugReverseContinue = new _n("debug-reverse-continue", {
            fontCharacter: "\\eb8e"
        }), _n.debugStepBack = new _n("debug-step-back", {
            fontCharacter: "\\eb8f"
        }), _n.debugRestartFrame = new _n("debug-restart-frame", {
            fontCharacter: "\\eb90"
        }), _n.callIncoming = new _n("call-incoming", {
            fontCharacter: "\\eb92"
        }), _n.callOutgoing = new _n("call-outgoing", {
            fontCharacter: "\\eb93"
        }), _n.menu = new _n("menu", {
            fontCharacter: "\\eb94"
        }), _n.expandAll = new _n("expand-all", {
            fontCharacter: "\\eb95"
        }), _n.feedback = new _n("feedback", {
            fontCharacter: "\\eb96"
        }), _n.groupByRefType = new _n("group-by-ref-type", {
            fontCharacter: "\\eb97"
        }), _n.ungroupByRefType = new _n("ungroup-by-ref-type", {
            fontCharacter: "\\eb98"
        }), _n.account = new _n("account", {
            fontCharacter: "\\eb99"
        }), _n.bellDot = new _n("bell-dot", {
            fontCharacter: "\\eb9a"
        }), _n.debugConsole = new _n("debug-console", {
            fontCharacter: "\\eb9b"
        }), _n.library = new _n("library", {
            fontCharacter: "\\eb9c"
        }), _n.output = new _n("output", {
            fontCharacter: "\\eb9d"
        }), _n.runAll = new _n("run-all", {
            fontCharacter: "\\eb9e"
        }), _n.syncIgnored = new _n("sync-ignored", {
            fontCharacter: "\\eb9f"
        }), _n.pinned = new _n("pinned", {
            fontCharacter: "\\eba0"
        }), _n.githubInverted = new _n("github-inverted", {
            fontCharacter: "\\eba1"
        }), _n.debugAlt = new _n("debug-alt", {
            fontCharacter: "\\eb91"
        }), _n.serverProcess = new _n("server-process", {
            fontCharacter: "\\eba2"
        }), _n.serverEnvironment = new _n("server-environment", {
            fontCharacter: "\\eba3"
        }), _n.pass = new _n("pass", {
            fontCharacter: "\\eba4"
        }), _n.stopCircle = new _n("stop-circle", {
            fontCharacter: "\\eba5"
        }), _n.playCircle = new _n("play-circle", {
            fontCharacter: "\\eba6"
        }), _n.record = new _n("record", {
            fontCharacter: "\\eba7"
        }), _n.debugAltSmall = new _n("debug-alt-small", {
            fontCharacter: "\\eba8"
        }), _n.vmConnect = new _n("vm-connect", {
            fontCharacter: "\\eba9"
        }), _n.cloud = new _n("cloud", {
            fontCharacter: "\\ebaa"
        }), _n.merge = new _n("merge", {
            fontCharacter: "\\ebab"
        }), _n.exportIcon = new _n("export", {
            fontCharacter: "\\ebac"
        }), _n.graphLeft = new _n("graph-left", {
            fontCharacter: "\\ebad"
        }), _n.magnet = new _n("magnet", {
            fontCharacter: "\\ebae"
        }), _n.notebook = new _n("notebook", {
            fontCharacter: "\\ebaf"
        }), _n.redo = new _n("redo", {
            fontCharacter: "\\ebb0"
        }), _n.checkAll = new _n("check-all", {
            fontCharacter: "\\ebb1"
        }), _n.pinnedDirty = new _n("pinned-dirty", {
            fontCharacter: "\\ebb2"
        }), _n.passFilled = new _n("pass-filled", {
            fontCharacter: "\\ebb3"
        }), _n.circleLargeFilled = new _n("circle-large-filled", {
            fontCharacter: "\\ebb4"
        }), _n.circleLargeOutline = new _n("circle-large-outline", {
            fontCharacter: "\\ebb5"
        }), _n.combine = new _n("combine", {
            fontCharacter: "\\ebb6"
        }), _n.gather = new _n("gather", {
            fontCharacter: "\\ebb6"
        }), _n.table = new _n("table", {
            fontCharacter: "\\ebb7"
        }), _n.variableGroup = new _n("variable-group", {
            fontCharacter: "\\ebb8"
        }), _n.typeHierarchy = new _n("type-hierarchy", {
            fontCharacter: "\\ebb9"
        }), _n.typeHierarchySub = new _n("type-hierarchy-sub", {
            fontCharacter: "\\ebba"
        }), _n.typeHierarchySuper = new _n("type-hierarchy-super", {
            fontCharacter: "\\ebbb"
        }), _n.gitPullRequestCreate = new _n("git-pull-request-create", {
            fontCharacter: "\\ebbc"
        }), _n.runAbove = new _n("run-above", {
            fontCharacter: "\\ebbd"
        }), _n.runBelow = new _n("run-below", {
            fontCharacter: "\\ebbe"
        }), _n.notebookTemplate = new _n("notebook-template", {
            fontCharacter: "\\ebbf"
        }), _n.debugRerun = new _n("debug-rerun", {
            fontCharacter: "\\ebc0"
        }), _n.workspaceTrusted = new _n("workspace-trusted", {
            fontCharacter: "\\ebc1"
        }), _n.workspaceUntrusted = new _n("workspace-untrusted", {
            fontCharacter: "\\ebc2"
        }), _n.workspaceUnspecified = new _n("workspace-unspecified", {
            fontCharacter: "\\ebc3"
        }), _n.terminalCmd = new _n("terminal-cmd", {
            fontCharacter: "\\ebc4"
        }), _n.terminalDebian = new _n("terminal-debian", {
            fontCharacter: "\\ebc5"
        }), _n.terminalLinux = new _n("terminal-linux", {
            fontCharacter: "\\ebc6"
        }), _n.terminalPowershell = new _n("terminal-powershell", {
            fontCharacter: "\\ebc7"
        }), _n.terminalTmux = new _n("terminal-tmux", {
            fontCharacter: "\\ebc8"
        }), _n.terminalUbuntu = new _n("terminal-ubuntu", {
            fontCharacter: "\\ebc9"
        }), _n.terminalBash = new _n("terminal-bash", {
            fontCharacter: "\\ebca"
        }), _n.arrowSwap = new _n("arrow-swap", {
            fontCharacter: "\\ebcb"
        }), _n.copy = new _n("copy", {
            fontCharacter: "\\ebcc"
        }), _n.personAdd = new _n("person-add", {
            fontCharacter: "\\ebcd"
        }), _n.filterFilled = new _n("filter-filled", {
            fontCharacter: "\\ebce"
        }), _n.wand = new _n("wand", {
            fontCharacter: "\\ebcf"
        }), _n.debugLineByLine = new _n("debug-line-by-line", {
            fontCharacter: "\\ebd0"
        }), _n.inspect = new _n("inspect", {
            fontCharacter: "\\ebd1"
        }), _n.layers = new _n("layers", {
            fontCharacter: "\\ebd2"
        }), _n.layersDot = new _n("layers-dot", {
            fontCharacter: "\\ebd3"
        }), _n.layersActive = new _n("layers-active", {
            fontCharacter: "\\ebd4"
        }), _n.compass = new _n("compass", {
            fontCharacter: "\\ebd5"
        }), _n.compassDot = new _n("compass-dot", {
            fontCharacter: "\\ebd6"
        }), _n.compassActive = new _n("compass-active", {
            fontCharacter: "\\ebd7"
        }), _n.azure = new _n("azure", {
            fontCharacter: "\\ebd8"
        }), _n.issueDraft = new _n("issue-draft", {
            fontCharacter: "\\ebd9"
        }), _n.gitPullRequestClosed = new _n("git-pull-request-closed", {
            fontCharacter: "\\ebda"
        }), _n.gitPullRequestDraft = new _n("git-pull-request-draft", {
            fontCharacter: "\\ebdb"
        }), _n.debugAll = new _n("debug-all", {
            fontCharacter: "\\ebdc"
        }), _n.debugCoverage = new _n("debug-coverage", {
            fontCharacter: "\\ebdd"
        }), _n.runErrors = new _n("run-errors", {
            fontCharacter: "\\ebde"
        }), _n.folderLibrary = new _n("folder-library", {
            fontCharacter: "\\ebdf"
        }), _n.debugContinueSmall = new _n("debug-continue-small", {
            fontCharacter: "\\ebe0"
        }), _n.beakerStop = new _n("beaker-stop", {
            fontCharacter: "\\ebe1"
        }), _n.graphLine = new _n("graph-line", {
            fontCharacter: "\\ebe2"
        }), _n.graphScatter = new _n("graph-scatter", {
            fontCharacter: "\\ebe3"
        }), _n.pieChart = new _n("pie-chart", {
            fontCharacter: "\\ebe4"
        }), _n.bracket = new _n("bracket", _n.json.definition), _n.bracketDot = new _n("bracket-dot", {
            fontCharacter: "\\ebe5"
        }), _n.bracketError = new _n("bracket-error", {
            fontCharacter: "\\ebe6"
        }), _n.lockSmall = new _n("lock-small", {
            fontCharacter: "\\ebe7"
        }), _n.azureDevops = new _n("azure-devops", {
            fontCharacter: "\\ebe8"
        }), _n.verifiedFilled = new _n("verified-filled", {
            fontCharacter: "\\ebe9"
        }), _n.newLine = new _n("newline", {
            fontCharacter: "\\ebea"
        }), _n.layout = new _n("layout", {
            fontCharacter: "\\ebeb"
        }), _n.layoutActivitybarLeft = new _n("layout-activitybar-left", {
            fontCharacter: "\\ebec"
        }), _n.layoutActivitybarRight = new _n("layout-activitybar-right", {
            fontCharacter: "\\ebed"
        }), _n.layoutPanelLeft = new _n("layout-panel-left", {
            fontCharacter: "\\ebee"
        }), _n.layoutPanelCenter = new _n("layout-panel-center", {
            fontCharacter: "\\ebef"
        }), _n.layoutPanelJustify = new _n("layout-panel-justify", {
            fontCharacter: "\\ebf0"
        }), _n.layoutPanelRight = new _n("layout-panel-right", {
            fontCharacter: "\\ebf1"
        }), _n.layoutPanel = new _n("layout-panel", {
            fontCharacter: "\\ebf2"
        }), _n.layoutSidebarLeft = new _n("layout-sidebar-left", {
            fontCharacter: "\\ebf3"
        }), _n.layoutSidebarRight = new _n("layout-sidebar-right", {
            fontCharacter: "\\ebf4"
        }), _n.layoutStatusbar = new _n("layout-statusbar", {
            fontCharacter: "\\ebf5"
        }), _n.layoutMenubar = new _n("layout-menubar", {
            fontCharacter: "\\ebf6"
        }), _n.layoutCentered = new _n("layout-centered", {
            fontCharacter: "\\ebf7"
        }), _n.layoutSidebarRightOff = new _n("layout-sidebar-right-off", {
            fontCharacter: "\\ec00"
        }), _n.layoutPanelOff = new _n("layout-panel-off", {
            fontCharacter: "\\ec01"
        }), _n.layoutSidebarLeftOff = new _n("layout-sidebar-left-off", {
            fontCharacter: "\\ec02"
        }), _n.target = new _n("target", {
            fontCharacter: "\\ebf8"
        }), _n.indent = new _n("indent", {
            fontCharacter: "\\ebf9"
        }), _n.recordSmall = new _n("record-small", {
            fontCharacter: "\\ebfa"
        }), _n.errorSmall = new _n("error-small", {
            fontCharacter: "\\ebfb"
        }), _n.arrowCircleDown = new _n("arrow-circle-down", {
            fontCharacter: "\\ebfc"
        }), _n.arrowCircleLeft = new _n("arrow-circle-left", {
            fontCharacter: "\\ebfd"
        }), _n.arrowCircleRight = new _n("arrow-circle-right", {
            fontCharacter: "\\ebfe"
        }), _n.arrowCircleUp = new _n("arrow-circle-up", {
            fontCharacter: "\\ebff"
        }), _n.heartFilled = new _n("heart-filled", {
            fontCharacter: "\\ec04"
        }), _n.map = new _n("map", {
            fontCharacter: "\\ec05"
        }), _n.mapFilled = new _n("map-filled", {
            fontCharacter: "\\ec06"
        }), _n.circleSmall = new _n("circle-small", {
            fontCharacter: "\\ec07"
        }), _n.bellSlash = new _n("bell-slash", {
            fontCharacter: "\\ec08"
        }), _n.bellSlashDot = new _n("bell-slash-dot", {
            fontCharacter: "\\ec09"
        }), _n.commentUnresolved = new _n("comment-unresolved", {
            fontCharacter: "\\ec0a"
        }), _n.gitPullRequestGoToChanges = new _n("git-pull-request-go-to-changes", {
            fontCharacter: "\\ec0b"
        }), _n.gitPullRequestNewChanges = new _n("git-pull-request-new-changes", {
            fontCharacter: "\\ec0c"
        }), _n.dialogError = new _n("dialog-error", _n.error.definition), _n.dialogWarning = new _n("dialog-warning", _n.warning.definition), _n.dialogInfo = new _n("dialog-info", _n.info.definition), _n.dialogClose = new _n("dialog-close", _n.close.definition), _n.treeItemExpanded = new _n("tree-item-expanded", _n.chevronDown.definition), _n.treeFilterOnTypeOn = new _n("tree-filter-on-type-on", _n.listFilter.definition), _n.treeFilterOnTypeOff = new _n("tree-filter-on-type-off", _n.listSelection.definition), _n.treeFilterClear = new _n("tree-filter-clear", _n.close.definition), _n.treeItemLoading = new _n("tree-item-loading", _n.loading.definition), _n.menuSelection = new _n("menu-selection", _n.check.definition), _n.menuSubmenu = new _n("menu-submenu", _n.chevronRight.definition), _n.menuBarMore = new _n("menubar-more", _n.more.definition), _n.scrollbarButtonLeft = new _n("scrollbar-button-left", _n.triangleLeft.definition), _n.scrollbarButtonRight = new _n("scrollbar-button-right", _n.triangleRight.definition), _n.scrollbarButtonUp = new _n("scrollbar-button-up", _n.triangleUp.definition), _n.scrollbarButtonDown = new _n("scrollbar-button-down", _n.triangleDown.definition), _n.toolBarMore = new _n("toolbar-more", _n.more.definition), _n.quickInputBack = new _n("quick-input-back", _n.arrowLeft.definition),
        function(e) {
            ...
            function n(e) {
                if (e instanceof _n) return ["codicon", "codicon-" + e.id];
                const r = t.exec(e.id);
                if (!r) return n(_n.error);
                const [, i, o] = r, a = ["codicon", "codicon-" + i];
    ...
    var yn, vn, Sn, Ln, Nn, En, An, kn = function(e, t, n, r) {
    ...
    function(e) {
        const t = new Map;
        t.set(0, _n.symbolFile), t.set(1, _n.symbolModule), t.set(2, _n.symbolNamespace), t.set(3, _n.symbolPackage), t.set(4, _n.symbolClass), t.set(5, _n.symbolMethod), t.set(6, _n.symbolProperty), t.set(7, _n.symbolField), t.set(8, _n.symbolConstructor), t.set(9, _n.symbolEnum), t.set(10, _n.symbolInterface), t.set(11, _n.symbolFunction), t.set(12, _n.symbolVariable), t.set(13, _n.symbolConstant), t.set(14, _n.symbolString), t.set(15, _n.symbolNumber), t.set(16, _n.symbolBoolean), t.set(17, _n.symbolArray), t.set(18, _n.symbolObject), t.set(19, _n.symbolKey), t.set(20, _n.symbolNull), t.set(21, _n.symbolEnumMember), t.set(22, _n.symbolStruct), t.set(23, _n.symbolEvent), t.set(24, _n.symbolOperator), t.set(25, _n.symbolTypeParameter), e.toIcon = function(e) {
            let n = t.get(e);
            return n || (console.info("No codicon found for SymbolKind " + e), n = _n.symbolProperty), n
        }
    }(Nn || (Nn = {}));
    class On {
        constructor(e) {
    ...
    On.Comment = new On("comment"), On.Imports = new On("imports"), On.Region = new On("region"),
        function(e) {
            e.is = function(e) {
    ...
    new class {
        constructor() {
            this._map = new Map, this._factories = new Map, this._onDidChange = new ie, this.onDidChange = this._onDidChange.event, this._colorMap = null
        }
        fire(e) {
    ...
    var xn, Tn, In, Pn, Kn, Dn, Vn, Fn, Bn, Un, qn, Hn, Wn, $n, zn, jn, Gn, Yn, Zn, Jn, Qn, Xn, er, tr, nr, rr, ir, or, ar, sr, lr, cr, hr, ur, dr, fr, mr, gr;
    ! function(e) {
    ...
    br.CtrlCmd = 2048, br.Shift = 1024, br.Alt = 512, br.WinCtrl = 256;
    class Cr extends Gt {
        constructor(e) {
            super(0);
        ...
        next(e) {
            ...
            do {
                ...
                if (r === this._prevMatchStartIndex && i === this._prevMatchLength) {
                    if (0 === i) {
                        be(e, t, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
                        continue
                    }
                    return null
                }
                if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || yr(this._wordSeparators, e, t, r, i)) return n
            } while (n);
            return null
        }
    }
    class Sr {
        constructor(e) {
            this.options = e, this.allowedCodePoints = new Set(e.allowedCodePoints), this.ambiguousCharacters = we.getInstance(new Set(e.allowedLocales))
        }
        getCandidateCodePoints() {
            if (this.options.nonBasicASCII) return "allNonBasicAscii";
            const e = new Set;
            if (this.options.invisibleCharacters)
                for (const t of _e.codePoints) Lr(String.fromCodePoint(t)) || e.add(t);
            ...
            if (t)
                for (const e of t) {
                    const t = e.codePointAt(0),
                        n = (o = e, Ce.test(o));
                    r = r || n, n || this.ambiguousCharacters.isAmbiguous(t) || _e.isInvisibleCharacter(t) || (i = !0)
                }
            var o;
            return !r && i ? 0 : this.options.invisibleCharacters && !Lr(e) && _e.isInvisibleCharacter(n) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(n) ? 3 : 0
        }
    }
    ...
    class Er extends class {
        ...
        onEvents(e) {
            ...
            const t = e.changes;
            for (const e of t) this._acceptDeleteRange(e.range), this._acceptInsertText(new At(e.range.startLineNumber, e.range.startColumn), e.text);
        ...
        getWordAtPosition(e, t) {
            const n = zt(e.column, function(e) {
                let t = Wt;
            ...
            return n ? new kt(e.lineNumber, n.startColumn, e.lineNumber, n.endColumn) : null
        }
        words(e) {
            const t = this._lines,
        ...
        _validatePosition(e) {
            if (!At.isIPosition(e)) throw new Error("bad position");
            let {
                lineNumber: t,
                column: n
            } = e, r = !1;
    ...
    class Ar {
        ...
        acceptNewModel(e) {
            this._models[e.url] = new Er(bt.parse(e.url), e.lines, e.EOL, e.versionId)
        }
            ...
            return Nr(this, void 0, void 0, (function*() {
                ...
                return r ? class {
                    static computeUnicodeHighlights(e, t, n) {
                        ...
                        let s;
                        s = "allNonBasicAscii" === a ? new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : new RegExp(`[${ue(Array.from(a).map((e=>String.fromCodePoint(e))).join(""))}]`, "g");
                        const l = new vr(null, s),
                            c = [];
                        let h, u = !1,
                            d = 0,
                            f = 0,
                        ...
                        e: for (let t = r, n = i; t <= n; t++) {
                            ...
                            do {
                                if (h = l.next(n), h) {
                                    ...
                                    e > 0 && fe(n.charCodeAt(e - 1)) && e--, i + 1 < r && fe(n.charCodeAt(i - 1)) && i++;
                                    const a = n.substring(e, i),
                                        s = zt(e + 1, Wt, n, 0),
                                        l = o.shouldHighlightNonBasicASCII(a, s ? s.word : null);
                                    if (0 !== l) {
                                        3 === l ? d++ : 2 === l ? f++ : 1 === l ? m++ : le(l);
                                        const n = 1e3;
                                        if (c.length >= n) {
                                            u = !0;
                                            break e
                                        }
                                        c.push(new kt(t, e + 1, t, i + 1))
                                    }
                                }
                            } while (h)
                        }
                            ...
                            case 3:
                                {
                                    const r = e.codePointAt(0),
                                        ...
                                        o = we.getLocales().filter((e => !we.getInstance(new Set([...t.allowedLocales, e])).isAmbiguous(r)));
                                    return {
                                        kind: 0,
        ...
        computeDiff(e, t, n, r) {
            return Nr(this, void 0, void 0, (function*() {
                const i = this._getModel(e),
                    o = this._getModel(t);
                return i && o ? Ar.computeDiff(i, o, n, r) : null
            }))
        }
        static computeDiff(e, t, n, r) {
            const i = e.getLinesContent(),
                ...
                s = !(a.changes.length > 0) && this._modelsAreIdentical(e, t);
            return {
                quitEarly: a.quitEarly,
                identical: s,
                changes: a.changes
            }
        }
        ...
        computeMoreMinimalEdits(e, t) {
            return Nr(this, void 0, void 0, (function*() {
                ...
                t = t.slice(0).sort(((e, t) => {
                    if (e.range && t.range) return kt.compareRangesUsingStarts(e.range, t.range);
                ...
                for (let {
                    ...
                    if ("number" == typeof a && (i = a), kt.isEmpty(e) && !o) continue;
                    const t = n.getValueInRange(e);
                    if (o = o.replace(/\r\n|\n|\r/g, n.eol), t === o) continue;
                    if (Math.max(o.length, t.length) > Ar._diffLimit) {
                        r.push({
                            range: e,
                            text: o
                        });
                    ...
                    const s = qe(t, o, !1),
                        l = n.offsetAt(kt.lift(e).getStartPosition());
                    for (const e of s) {
        ...
        computeLinks(e) {
            return Nr(this, void 0, void 0, (function*() {
                ...
                return t ? function(e) {
                    return e && "function" == typeof e.getLineCount && "function" == typeof e.getLineContent ? Xt.computeLinks(e) : []
                }(t) : null
            }))
        }
                ...
                e: for (const n of e) {
                    ...
                    if (e)
                        for (const n of e.words(o))
                            if (n !== t && isNaN(Number(n)) && (a.add(n), a.size > Ar._suggestionsLimit)) break e
                }
                return {
                    words: Array.from(a),
                    duration: i.elapsed()
        ...
        navigateValueSet(e, t, n, r, i) {
            return Nr(this, void 0, void 0, (function*() {
                ...
                return en.INSTANCE.navigateValueSet(t, s, l, c, n)
            }))
        }
        loadForeignModule(e, t, n) {
            ...
            return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(i, t), Promise.resolve(se(this._foreignModule))) : Promise.reject(new Error("Unexpected usage"))
        }
        fmr(e, t) {
    ...
    Ar._diffLimit = 1e5, Ar._suggestionsLimit = 1e4, "function" == typeof importScripts && (q.monaco = {
        editor: void 0,
        languages: void 0,
        CancellationTokenSource: on,
        Emitter: ie,
        KeyCode: Zn,
        KeyMod: br,
        Position: At,
