(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [179], {
        16862: function(e, t, n) {
            ...
            r.SENTRY_RELEASE = {
                id: "1141f8cf"
            }, r.SENTRY_RELEASES = r.SENTRY_RELEASES || {}, r.SENTRY_RELEASES["frontendx@leetcode"] = {
                id: "1141f8cf"
            }
        },
        25300: function(e, t) {
        ...
        77339: function(e, t, n) {
            ...
            var T = y.default();
            t.emitter = T;
            var k, I, N, D, B, Z, q, H, F, U, W = function(e) {
                    return [].slice.call(e)
                },
                z = void 0,
                G = !1;
            ...
            var V = function(e) {
                ...
                return a(n, [{
                    ...
                    value: function() {
                        this.scrollToHash(), p.isSsr && "/404" !== k.page && "/_error" !== k.page && (k.isFallback || k.nextExport && (g.isDynamicRoute(p.pathname) || location.search || G) || k.props && k.props.__N_SSG && (location.search || G)) && p.replace(p.pathname + "?" + String(_.assign(_.urlQueryToSearchParams(p.query), new URLSearchParams(location.search))), I, {
                            _h: 1,
            ...
            function K() {
                return K = s((function() {
                    ...
                    return l(this, (function(a) {
                        return r.length > 0 && void 0 !== r[0] ? r[0] : {}, k = JSON.parse(document.getElementById("__NEXT_DATA__").textContent), window.__NEXT_DATA__ = k, z = k.defaultLocale, e = k.assetPrefix || "", n.p = "".concat(e, "/_next/"), b.setConfig({
                            serverRuntimeConfig: {},
                            publicRuntimeConfig: k.runtimeConfig || {}
                        }), I = P.getURL(), A.hasBasePath(I) && (I = R.removeBasePath(I)), k.scriptLoader && (0, n(20699).initScriptLoader)(k.scriptLoader), N = new O.default(k.buildId, e), t = function(e) {
                            var t = u(e, 2),
                                n = t[0],
                                r = t[1];
                    ...
                    return l(this, (function(l) {
                        switch (l.label) {
                            ...
                            case 8:
                                l.sent(), l.label = 9;
                            case 9:
                                return t.router = p = x.createRouter(k.page, k.query, I, {
                ...
                return (Z = u((function(e) {
                    ...
                    return i(this, (function(i) {
                        switch (i.label) {
                            ...
                            case 1:
                                return (t = i.sent()) ? (n = x.parsePath(e.asPath), r = n.pathname, a = L.hasBasePath(r) ? R.removeBasePath(r) : r, o = A.addBasePath(M.addLocale(a, e.locale)), [2, t.some((function(e) {
                    ...
                    return t && e.fetchData ? e.fetchData().then((function(t) {
                        return function(e, t, n) {
                            ...
                            if (y) {
                                if (y.startsWith("/")) {
                                    var g = x.parsePath(y),
                                        _ = k.formatNextPathnameInfo(c({}, T.getNextPathnameInfo(g.pathname, {
                                            nextConfig: r,
                                            parseData: !0
                                        }), {
                                            defaultLocale: n.router.defaultLocale,
                ...
                re = function() {
                    ...
                    return a(e, [{
                        ...
                        value: function(t, n, r, a, l) {
                            var s = this;
                            return u((function() {
                                var u, f, y, m, g, w, S, T, k, N, Z, q, W, V, $, X, Y, J, Q, ee, ne, re, ae, oe, ie, ue, ce, le, se, fe, de, pe, he, ve, ye, me, ge, _e, be, Pe, we, Se, Oe, je, Ee, xe, Me, Ce, Re, Ae, Le, Te, ke, Ie, Ne, De, Be, Ze;
                                return i(this, (function(i) {
                                    switch (i.label) {
                                        case 0:
                                            if (!F(n)) return te({
                                            ...
                                            if (w = y.locale, _.ST && performance.mark("routeChange"), S = a.shallow, T = void 0 !== S && S, k = a.scroll, N = void 0 === k || k, Z = {
                                                    shallow: T
                                                }, s._inFlightRoute && s.clc && (g || e.events.emit("routeChangeError", D(), s._inFlightRoute, Z), s.clc(), s.clc = null), r = A.addBasePath(M.addLocale(L.hasBasePath(r) ? R.removeBasePath(r) : r, a.locale, s.defaultLocale)), q = C.removeLocale(L.hasBasePath(r) ? R.removeBasePath(r) : r, y.locale), s._inFlightRoute = r, W = w !== y.locale, u || !s.onlyAHashChange(q) || W) return [3, 5];
                                        ...
                                        case 12:
                                            if ("route" in (he = i.sent()) && re && (X = he.route || ae, ae = X, Z.shallow || (Y = Object.assign({}, he.query || {}, Y)), ve = L.hasBasePath($.pathname) ? R.removeBasePath($.pathname) : $.pathname, oe && X !== ve && Object.keys(oe).forEach((function(e) {
                                                    oe && Y[e] === oe[e] && delete Y[e]
                                                })), b.isDynamicRoute(X) && (ye = !Z.shallow && he.resolvedAs ? he.resolvedAs : A.addBasePath(M.addLocale(new URL(r, location.href).pathname, y.locale), !0), me = ye, L.hasBasePath(me) && (me = R.removeBasePath(me)), ge = j.getRouteRegex(X), (_e = O.getRouteMatcher(ge)(me)) && Object.assign(Y, _e))), "type" in he) return "redirect-internal" === he.type ? [2, s.change(t, he.newUrl, he.newAs, a)] : (te({
                                                url: he.destination,
                                                router: s
                                        ...
                                        case 17:
                                            ...
                                            i.label = 18;
                                        case 18:
                                            return e.events.emit("beforeHistoryChange", r, Z), s.changeState(t, n, r, a), u && "/_error" === X && 500 === (null == (de = self.__NEXT_DATA__.props) || null == (pe = de.pageProps) ? void 0 : pe.statusCode) && (null == Pe ? void 0 : Pe.pageProps) && (Pe.pageProps.statusCode = 500), Le = a.shallow && y.route === (null != (Ae = he.route) ? Ae : ae), ke = null != (Te = a.scroll) ? Te : !a._h && !Le, Ie = ke ? {
                                                x: 0,
                                                y: 0
                                            } : null, Ne = c({}, y, {
                                                route: ae,
                                        ...
                                        case 19:
                                            ...
                                            0, u || e.events.emit("routeChangeComplete", r, Z), Be = /#.+$/, ke && Be.test(r) && s.scrollToHash(r), i.label = 20;
                                        case 20:
                                            return [2, !0];
                                        case 21:
                        ...
                        value: function(e) {
                            var t = e.route,
                                ...
                                y = this;
                            return u((function() {
                                var e, g, _, b, P, w, S, O, j, x, M, C, A, L, T, k;
                                return i(this, (function(I) {
                                    switch (I.label) {
                                        case 0:
                                            e = t, I.label = 1;
                                        ...
                                        case 5:
                                            return A = I.sent(), L = A.props, T = A.cacheKey, x.__N_SSP && O.dataHref && delete y.sdc[T], !y.isPreview && x.__N_SSG && Q(Object.assign({}, O, {
                                                isBackground: !0,
                                                persistCache: !1,
                                                inflightCache: X
                                            })).catch((function() {})), L.pageProps = Object.assign({}, L.pageProps), x.props = L, x.route = e, x.query = r, x.resolvedAs = o, y.components[e] = x, [2, x];
                                        case 6:
                                            return k = I.sent(), [2, y.handleRouteInfoError(v.getProperError(k), n, r, a, l)];
                                        case 7:
                                            return [2]
                                    }
                                }))
