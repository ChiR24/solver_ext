    ...
    [1265], {
        41008: function(e, t, r) {
            ...
            class i {
                constructor(e, t) {
                    ...
                    if (n && n.start <= n.end) {
                        ...
                        a += (r > 15 ? "\u2026" + o.slice(r - 15, r) : o.slice(0, r)) + l + (s + 15 < o.length ? o.slice(s, s + 15) + "\u2026" : o.slice(s))
                    }
                    var h = new Error(a);
            ...
            var wa = {
                ...
                Ma = (e, t) => {
                    var r = e.font;
                    return r ? wa[r] ? t.withTextFontFamily(wa[r]) : ka[r] ? t.withTextFontWeight(ka[r]) : t.withTextFontShape(Sa[r]) : t
                };
            ot({
                type: "text",
            ...
            class Da {
                ...
                expandTokens(e) {
                    ...
                    for (this.pushTokens(e); this.stack.length > r;) {
                        ...
                        a instanceof n && (a.treatAsRelax && (a.noexpand = !1, a.treatAsRelax = !1), t.push(this.stack.pop()))
                    }
                    return t
                }
                expandMacroAsText(e) {
                    ...
                    for (;;) {
                        ...
                        if ("\\limits" === n.text || "\\nolimits" === n.text) {
                            if (a && "op" === a.type) {
                                ...
                                if (!a || "operatorname" !== a.type) throw new i("Limit controls must follow a math operator", n);
