        ...
        48418: function(e, t, o) {
            ...
            var b = u.default.forwardRef((function(e, t) {
                var o, r = e.href,
                    ...
                    R = e.onTouchStart,
                    O = e.legacyBehavior,
                    E = void 0 === O ? !0 !== Boolean(!1) : O,
                    k = a(e, ["href", "as", "children", "prefetch", "passHref", "replace", "shallow", "scroll", "locale", "onClick", "onMouseEnter", "onTouchStart", "legacyBehavior"]);
                o = h, !E || "string" !== typeof o && "number" !== typeof o || (o = u.default.createElement("a", null, o));
                var P = !1 !== C,
                    w = u.default.useContext(c.RouterContext),
                    T = u.default.useContext(i.AppRouterContext);
                T && (w = T);
                var I, S = u.default.useMemo((function() {
                        var e = n(l.resolveHref(w, r, !0), 2),
                            t = e[0],
                            o = e[1];
                        return {
                            href: t,
                            as: b ? l.resolveHref(w, b) : o || t
                        }
                    }), [w, r, b]),
                    U = S.href,
                    B = S.as,
                ...
                E && (I = u.default.Children.only(o));
                var A = E ? I && "object" === typeof I && I.ref : t,
                ...
                u.default.useEffect((function() {
                    var e = K && P && l.isLocalURL(U),
                        t = "undefined" !== typeof x ? x : w && w.locale,
                        o = v[U + "%" + B + (t ? "%" + t : "")];
                    e && !o && y(w, U, B, {
                        locale: t
                    })
                ...
                var z = {
                    ref: q,
                    onClick: function(e) {
                        E || "function" !== typeof L || L(e), E && I.props && "function" === typeof I.props.onClick && I.props.onClick(e), e.defaultPrevented || function(e, t, o, n, r, a, f, c, i, s) {
                        ...
                        }(e, w, U, B, g, M, m, x, Boolean(T), P)
                    },
                    onMouseEnter: function(e) {
                        E || "function" !== typeof j || j(e), E && I.props && "function" === typeof I.props.onMouseEnter && I.props.onMouseEnter(e), !P && T || l.isLocalURL(U) && y(w, U, B, {
                            priority: !0
                        })
                    },
                    onTouchStart: function(e) {
                        E || "function" !== typeof R || R(e), E && I.props && "function" === typeof I.props.onTouchStart && I.props.onTouchStart(e), !P && T || l.isLocalURL(U) && y(w, U, B, {
                            priority: !0
                        })
                    }
                };
                if (!E || _ || "a" === I.type && !("href" in I.props)) {
                    var F = "undefined" !== typeof x ? x : w && w.locale,
                        J = w && w.isLocaleDomain && d.getDomainLocale(B, F, w.locales, w.domainLocales);
                    z.href = J || p.addBasePath(f.addLocale(B, F, w && w.defaultLocale))
                }
                return E ? u.default.cloneElement(I, z) : u.default.createElement("a", Object.assign({}, k, z), o)
            }));
