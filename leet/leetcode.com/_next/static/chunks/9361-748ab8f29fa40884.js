(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9361], {
            ...
            o.prototype = {
                ...
                multiply: function(t) {
                    for (var e = new Array(this.getLength() + t.getLength() - 1), r = 0; r < this.getLength(); r++)
                        for (var i = 0; i < t.getLength(); i++) e[r + i] ^= n.gexp(n.glog(this.get(r)) + n.glog(t.get(i)));
                    return new o(e, 0)
                },
                mod: function(t) {
                    if (this.getLength() - t.getLength() < 0) return this;
                    for (var e = n.glog(this.get(0)) - n.glog(t.get(0)), r = new Array(this.getLength()), i = 0; i < this.getLength(); i++) r[i] = this.get(i);
                    for (i = 0; i < t.getLength(); i++) r[i] ^= n.gexp(n.glog(t.get(i)) + e);
                    return new o(r, 0).mod(t)
                }
            }, t.exports = o
        },
        14450: function(t, e, r) {
            var n = r(3655),
                o = r(17611),
                i = r(27321),
                a = r(93160),
            ...
            l.addData = function(t) {
                ...
                if (this.typeNumber < 1) {
                    var t = 1;
                    for (t = 1; t < 40; t++) {
                        for (var e = o.getRSBlocks(t, this.errorCorrectLevel), r = new i, n = 0, u = 0; u < e.length; u++) n += e[u].dataCount;
                ...
                for (var t = a.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
                    for (var r = 0; r < t.length; r++) {
                        ...
                        if (null == this.modules[n][o])
                            for (var i = -2; i <= 2; i++)
                                for (var u = -2; u <= 2; u++) this.modules[n + i][o + u] = -2 == i || 2 == i || -2 == u || 2 == u || 0 == i && 0 == u
                    }
                ...
                for (var r = -1, n = this.moduleCount - 1, o = 7, i = 0, u = this.moduleCount - 1; u > 0; u -= 2)
                    for (6 == u && u--;;) {
                        for (var s = 0; s < 2; s++)
                            if (null == this.modules[n][u - s]) {
                                var l = !1;
                                i < t.length && (l = 1 == (t[i] >>> o & 1)), a.getMask(e, n, u - s) && (l = !l), this.modules[n][u - s] = l, -1 == --o && (i++, o = 7)
                            }
                ...
                for (var n = o.getRSBlocks(t, e), u = new i, l = 0; l < r.length; l++) {
                    var h = r[l];
                    u.put(h.mode, 4), u.put(h.getLength(), a.getLengthInBits(h.mode, t)), h.write(u)
                }
                var f = 0;
                ...
                return s.createBytes(u, n)
            }, s.createBytes = function(t, e) {
                for (var r = 0, n = 0, o = 0, i = new Array(e.length), s = new Array(e.length), l = 0; l < e.length; l++) {
                    var h = e[l].dataCount,
                        f = e[l].totalCount - h;
                    n = Math.max(n, h), o = Math.max(o, f), i[l] = new Array(h);
                    for (var c = 0; c < i[l].length; c++) i[l][c] = 255 & t.buffer[c + r];
                    r += h;
                    var g = a.getErrorCorrectPolynomial(f),
                        d = new u(i[l], g.getLength() - 1).mod(g);
                    s[l] = new Array(g.getLength() - 1);
                    for (c = 0; c < s[l].length; c++) {
                        var p = c + d.getLength() - s[l].length;
                        s[l][c] = p >= 0 ? d.get(p) : 0
                    }
                }
                var m = 0;
                ...
                var v = new Array(m),
                    y = 0;
                for (c = 0; c < n; c++)
                    for (l = 0; l < e.length; l++) c < i[l].length && (v[y++] = i[l][c]);
                for (c = 0; c < o; c++)
                    for (l = 0; l < e.length; l++) c < s[l].length && (v[y++] = s[l][c]);
                return v
            }, t.exports = s
        },
        17611: function(t, e, r) {
            var n = r(49381);
            ...
            o.RS_BLOCK_TABLE = [
                ...
                for (var n = r.length / 3, i = new Array, a = 0; a < n; a++)
                    for (var u = r[3 * a + 0], s = r[3 * a + 1], l = r[3 * a + 2], h = 0; h < u; h++) i.push(new o(s, l));
                return i
            ...
            var n = r(32792),
                ...
                d = {
                    ...
                    getErrorCorrectPolynomial: function(t) {
                        for (var e = new o([1], 0), r = 0; r < t; r++) e = e.multiply(new o([1, i.gexp(r)], 0));
                        return e
                    },
                    ...
                    getLostPoint: function(t) {
                        ...
                        for (n = 0; n < e - 1; n++)
                            for (o = 0; o < e - 1; o++) {
                                var l = 0;
                                t.isDark(n, o) && l++, t.isDark(n + 1, o) && l++, t.isDark(n, o + 1) && l++, t.isDark(n + 1, o + 1) && l++, 0 != l && 4 != l || (r += 3)
                            }
                        for (n = 0; n < e; n++)
        ...
        79361: function(t, e, r) {
            ...
            function f(t, e) {
                return !e || "object" !== n(e) && "function" !== typeof e ? g(t) : e
            }
            ...
            function w(t) {
                for (var e = "", r = 0; r < t.length; r++) {
                    ...
                    n < 128 ? e += String.fromCharCode(n) : n < 2048 ? (e += String.fromCharCode(192 | n >> 6), e += String.fromCharCode(128 | 63 & n)) : n < 55296 || n >= 57344 ? (e += String.fromCharCode(224 | n >> 12), e += String.fromCharCode(128 | n >> 6 & 63), e += String.fromCharCode(128 | 63 & n)) : (r++, n = 65536 + ((1023 & n) << 10 | 1023 & t.charCodeAt(r)), e += String.fromCharCode(240 | n >> 18), e += String.fromCharCode(128 | n >> 12 & 63), e += String.fromCharCode(128 | n >> 6 & 63), e += String.fromCharCode(128 | 63 & n))
                }
                return e
            }
            var E = {
            ...
            function b(t) {
                ...
                return t.forEach((function(t, n) {
                    ...
                    t.forEach((function(i, a) {
                        if (!i && null !== o) return r.push("M".concat(o + e, " ").concat(n + e, "h").concat(a - o, "v1H").concat(o + e, "z")), void(o = null);
                        if (a !== t.length - 1) i && null === o && (o = a);
                        else {
                            if (!i) return;
                            null === o ? r.push("M".concat(a + e, ",").concat(n + e, " h1v1H").concat(a + e, "z")) : r.push("M".concat(o + e, ",").concat(n + e, " h").concat(a + 1 - o, "v1H").concat(o + e, "z"))
                        }
                    }))
                })), r.join("")
            }
            ...
            function L(t, e) {
                return t.slice().map((function(t, r) {
                    return r < e.y || r >= e.y + e.h ? t : t.map((function(t, r) {
                        return (r < e.x || r >= e.x + e.w) && t
                    }))
                }))
            }

            function P(t, e) {
                var r = t.imageSettings,
                    n = t.size,
                    o = t.includeMargin;
                ...
                var i = o ? 4 : 0,
                    ...
                    l = (r.width || u) * s,
                    h = (r.height || u) * s,
                    f = null == r.x ? e.length / 2 - l / 2 : r.x * s,
                    c = null == r.y ? e.length / 2 - h / 2 : r.y * s,
                    g = null;
                if (r.excavate) {
                    var d = Math.floor(f),
                        p = Math.floor(c);
            ...
            var _ = function() {
                ...
                B = function(t) {
                    function e() {
                        ...
                        return m(g(r = f(this, (t = c(e)).call.apply(t, [this].concat(o)))), "_canvas", void 0), m(g(r), "_image", void 0), m(g(r), "state", {
                            imgLoaded: !1
                        }), m(g(r), "handleImageLoad", (function() {
                            r.setState({
                                imgLoaded: !0
                            })
                        })), r
                    ...
                    return d(e, t), h(e, [{
                        ...
                        value: function(t) {
                            var e, r;
                            (null === (e = this.props.imageSettings) || void 0 === e ? void 0 : e.src) !== (null === (r = t.imageSettings) || void 0 === r ? void 0 : r.src) && this.setState({
                                imgLoaded: !1
                            })
                        }
                    }, {
                        ...
                        value: function() {
                            var t = this.props,
                                ...
                                u = t.imageSettings,
                                s = new y(-1, C[n]);
                            if (s.addData(w(e)), s.make(), null != this._canvas) {
                                var l = this._canvas,
                                    h = l.getContext("2d");
                                if (!h) return;
                                var f = s.modules;
                                ...
                                var c = a ? 4 : 0,
                                    g = f.length + 2 * c,
                                    d = P(this.props, f);
                                null != u && null != d && null != d.excavation && (f = L(f, d.excavation));
                                var p = window.devicePixelRatio || 1;
                                l.height = l.width = r * p;
                                var m = r / g * p;
                                h.scale(m, m), h.fillStyle = o, h.fillRect(0, 0, g, g), h.fillStyle = i, _ ? h.fill(new Path2D(b(f, c))) : f.forEach((function(t, e) {
                                    t.forEach((function(t, r) {
                                        t && h.fillRect(r + c, e + c, 1, 1)
                                    }))
                                })), this.state.imgLoaded && this._image && null != d && h.drawImage(this._image, d.x + c, d.y + c, d.w, d.h)
                            }
                        }
                    }, {
                        key: "render",
                        value: function() {
                            var t = this,
                                e = this.props,
                                r = (e.value, e.size),
                                n = (e.level, e.bgColor, e.fgColor, e.style),
                                i = (e.includeMargin, e.imageSettings),
                                s = u(e, ["value", "size", "level", "bgColor", "fgColor", "style", "includeMargin", "imageSettings"]),
                                l = a({
                                    height: r,
                                    width: r
                                }, n),
                                h = null,
                                f = i && i.src;
                            return null != i && null != f && (h = v.createElement("img", {
                                src: f,
                                style: {
                                    display: "none"
                                },
                            ...
                            })), v.createElement(v.Fragment, null, v.createElement("canvas", o({
                                style: l,
                                height: r,
                                width: r,
                                ref: function(e) {
            ...
            var D = function(t) {
                function e() {
                    return s(this, e), f(this, c(e).apply(this, arguments))
                }
                return d(e, t), h(e, [{
                    key: "render",
                    value: function() {
                        var t = this.props,
                            ...
                            s = t.includeMargin,
                            l = t.imageSettings,
                            h = u(t, ["value", "size", "level", "bgColor", "fgColor", "includeMargin", "imageSettings"]),
                            f = new y(-1, C[n]);
                        f.addData(w(e)), f.make();
                        var c = f.modules;
                        ...
                        var g = s ? 4 : 0,
                            ...
                            p = P(this.props, c),
                            m = null;
                        null != l && null != p && (null != p.excavation && (c = L(c, p.excavation)), m = v.createElement("image", {
                            xlinkHref: l.src,
                            height: p.h,
                            width: p.w,
                            x: p.x + g,
                        ...
                        return v.createElement("svg", o({
                            ...
                            fill: i,
                            d: "M0,0 h".concat(d, "v").concat(d, "H0z")
