/*! For license information please see defaultVendors-node_modules_node-polyfill-webpack-plugin_node_modules_buffer_index_js-bdab9501.js.LICENSE.txt */
(self.webpackChunkhackerrank_lib = self.webpackChunkhackerrank_lib || []).push([
    ["defaultVendors-node_modules_node-polyfill-webpack-plugin_node_modules_buffer_index_js"], {
        H7XF: (t, e) => {
            "use strict";
            e.byteLength = function(t) {
                ...
                for (var e, n = t.length, o = n % 3, i = [], f = 16383, s = 0, u = n - o; s < u; s += f) i.push(h(t, s, s + f > u ? u : s + f));
                return 1 === o ? (e = t[n - 1], i.push(r[e >> 2] + r[e << 4 & 63] + "==")) : 2 === o && (e = (t[n - 2] << 8) + t[n - 1], i.push(r[e >> 10] + r[e >> 4 & 63] + r[e << 2 & 63] + "=")), i.join("")
            };
            for (var r = [], n = [], o = "undefined" != typeof Uint8Array ? Uint8Array : Array, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", f = 0, s = i.length; f < s; ++f) r[f] = i[f], n[i.charCodeAt(f)] = f;
            ...
            function h(t, e, n) {
                for (var o, i, f = [], s = e; s < n; s += 3) o = (t[s] << 16 & 16711680) + (t[s + 1] << 8 & 65280) + (255 & t[s + 2]), f.push(r[(i = o) >> 18 & 63] + r[i >> 12 & 63] + r[i >> 6 & 63] + r[63 & i]);
                return f.join("")
            }
        ...
        r6pt: (t, e, r) => {
            ...
            function a(t, e, r) {
                ...
                if (X(t, ArrayBuffer) || t && X(t.buffer, ArrayBuffer)) return y(t, e, r);
                if ("undefined" != typeof SharedArrayBuffer && (X(t, SharedArrayBuffer) || t && X(t.buffer, SharedArrayBuffer))) return y(t, e, r);
                ...
                const o = function(t) {
                    ...
                    return void 0 !== t.length ? "number" != typeof t.length || J(t.length) ? u(0) : l(t) : "Buffer" === t.type && Array.isArray(t.data) ? l(t.data) : void 0
                }(t);
                if (o) return o;
            ...
            function y(t, e, r) {
                ...
                let n;
                return n = void 0 === e && void 0 === r ? new Uint8Array(t) : void 0 === r ? new Uint8Array(t, e) : new Uint8Array(t, e, r), Object.setPrototypeOf(n, h.prototype), n
            }
            ...
            function B(t, e, r, n, o) {
                ...
                if ("string" == typeof e && (e = h.from(e, n)), h.isBuffer(e)) return 0 === e.length ? -1 : m(t, e, r, n, o);
                    ...
                    if (o + f <= r) {
                        ...
                        switch (f) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                r = t[o + 1], n = t[o + 2], s = t[o + 3], 128 == (192 & r) && 128 == (192 & n) && 128 == (192 & s) && (u = (15 & e) << 18 | (63 & r) << 12 | (63 & n) << 6 | 63 & s, u > 65535 && u < 1114112 && (i = u))
                        }
                    }
                    null === i ? (i = 65533, f = 1) : i > 65535 && (i -= 65536, n.push(i >>> 10 & 1023 | 55296), i = 56320 | 1023 & i), n.push(i), o += f
                }
                return function(t) {
                    const e = t.length;
            ...
            h.TYPED_ARRAY_SUPPORT = function() {
            ...
            }(), h.TYPED_ARRAY_SUPPORT || void 0 === n || "function" != typeof n.error || n.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support."), Object.defineProperty(h.prototype, "parent", {
                enumerable: !0,
                get: function() {
                ...
                const n = h.allocUnsafe(e);
                let o = 0;
                for (r = 0; r < t.length; ++r) {
                    let e = t[r];
                    if (X(e, Uint8Array)) o + e.length > n.length ? (h.isBuffer(e) || (e = h.from(e)), e.copy(n, o)) : Uint8Array.prototype.set.call(n, e, o);
                    else {
            ...
            }, f && (h.prototype[f] = h.prototype.inspect), h.prototype.compare = function(t, e, r, n, o) {
            ...
            h.prototype.slice = function(t, e) {
                ...
                t = +t, e >>>= 0, r >>>= 0, n || $(this, t, e, r, Math.pow(2, 8 * r) - 1, 0);
                let o = 1,
                    i = 0;
            ...
            }, h.prototype.writeBigUInt64LE = Q((function(t, e = 0) {
                return k(this, t, e, BigInt(0), BigInt("0xffffffffffffffff"))
            })), h.prototype.writeBigUInt64BE = Q((function(t, e = 0) {
            ...
            }, h.prototype.writeBigInt64LE = Q((function(t, e = 0) {
                return k(this, t, e, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"))
            })), h.prototype.writeBigInt64BE = Q((function(t, e = 0) {
                ...
                if (e >>>= 0, r = void 0 === r ? this.length : r >>> 0, t || (t = 0), "number" == typeof t)
                    ...
                    const i = h.isBuffer(t) ? t : h.from(t, n),
                        f = i.length;
            ...
            function V(t, e, r, n, o, i) {
                if (t > r || t < e) {
                    ...
                    G(e, "offset"), void 0 !== t[e] && void 0 !== t[e + r] || Y(e, t.length - (r + 1))
                }(n, o, i)
            }
            ...
            function Y(t, e, r) {
                if (Math.floor(t) !== t) throw G(t, r), new j.ERR_OUT_OF_RANGE(r || "offset", "an integer", t);
...
//# sourceMappingURL=https://hrcdn.net/fcore/assets/sourcemaps/defaultVendors-node_modules_node-polyfill-webpack-plugin_node_modules_buffer_index_js-bdab9501.js.map