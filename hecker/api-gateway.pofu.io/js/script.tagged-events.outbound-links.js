! function() {
    ...
    function e(e, t) {
        if (/^localhost$|^127(\.[0-9]+){0,2}\.[0-9]+$|^\[::1?\]$/.test(r.hostname) || "file:" === r.protocol) return s("localhost", t);
        if (window._phantom || window.__nightmare || window.navigator.webdriver || window.Cypress) return s(null, t);
        try {
            if ("true" === window.localStorage.plausible_ignore) return s("localStorage flag", t)
        } catch (e) {}
        var n = {},
            a = (n.n = e, n.u = r.href, n.d = o.getAttribute("data-domain"), n.r = i.referrer || null, t && t.meta && (n.m = JSON.stringify(t.meta)), t && t.props && (n.p = t.props), new XMLHttpRequest);
        a.open("POST", l, !0), a.setRequestHeader("Content-Type", "text/plain"), a.send(JSON.stringify(n)), a.onreadystatechange = function() {
    ...
    function v(e) {
        var t, n;
        if ("auxclick" !== e.type || e.button === d) return (t = function(e) {
        ...
        }(t, 0) && (n = t) && n.href && n.host && n.host !== r.host ? m(e, t, {
    ...
    function m(e, t, n) {
        ...
        function r() {
            ...
            if (!e.defaultPrevented) return t = !t.target || t.target.match(/^_(self|parent|top)$/i), e = !(e.ctrlKey || e.metaKey || e.shiftKey) && "click" === e.type, t && e
        }(e, t) ? plausible(n.name, {
            props: n.props
        }): (plausible(n.name, {
            props: n.props,
            callback: r
    ...
    function h(e) {
        ...
        if (n)
            for (var a = 0; a < n.length; a++) {
                ...
                i && (r = i[1], i = i[3].replace(/\+/g, " "), "name" === r.toLowerCase() ? t.name = i : t.props[r] = i)
            }
        return t
    }
    ...
    function g(e) {
        if ("auxclick" !== e.type || e.button === d) {
            for (var t, n, a, r, i = e.target, o = 0; o <= w && i; o++) {
                if ((a = i) && a.tagName && "form" === a.tagName.toLowerCase()) return;
                f(i) && (t = i), b(i) && (n = i), i = i.parentNode
            }
            n && (r = h(n), t ? (r.props.url = t.href, m(e, t, r)) : plausible(r.name, {
                props: r.props
            }))
        }
    }
    ...
    i.addEventListener("submit", function(e) {
        ...
        a.name && (e.preventDefault(), t = !1, setTimeout(r, 5e3), plausible(a.name, {
            props: a.props,
            callback: r
        }))
